...
weekly_history = {
    "CBT":                                       {"30/mar":(75,9,86), "06/abr":(87,12,101), "13/abr":(87,15,102), "20/abr":(77,16,96), "27/abr":(56,10,67), "04/mai":(85,12,100), "11/mai":(59,14,75), "18/mai":(96,22,119), "25/mai":(94,12,107), "01/jun":(74,12,89), "08/jun":(100,12,116)},
    "Experiencia Impositiva Mature":             {"30/mar":(12,5,20), "06/abr":(9,3,13), "13/abr":(6,2,8), "20/abr":(2,0,4), "27/abr":(5,0,5), "04/mai":(5,0,5), "11/mai":(4,1,5), "18/mai":(2,1,3), "25/mai":(0,2,3), "01/jun":(3,2,5), "08/jun":(3,0,3)},
    "Experiencia Impositiva Meli Pro":           {"30/mar":(2,1,3), "06/abr":(1,0,2), "13/abr":(2,1,4), "20/abr":(3,0,3), "27/abr":(5,2,7), "04/mai":(2,1,3), "11/mai":(4,0,5), "18/mai":(7,2,10), "25/mai":(0,3,4), "01/jun":(3,4,7), "08/jun":(5,0,5)},
    "Experiencia Impositiva Seller Dev":         {"30/mar":(66,25,100), "06/abr":(150,36,208), "13/abr":(112,33,160), "20/abr":(57,23,88), "27/abr":(50,13,70), "04/mai":(72,36,116), "11/mai":(67,29,103), "18/mai":(89,20,118), "25/mai":(106,19,139), "01/jun":(78,17,100), "08/jun":(105,31,147)},
    "FBM-S Mature":                              {"30/mar":(30,13,48), "06/abr":(28,7,40), "13/abr":(23,4,29), "20/abr":(17,4,21), "27/abr":(13,3,20), "04/mai":(9,4,20), "11/mai":(12,11,25), "18/mai":(6,3,10), "25/mai":(12,2,16), "01/jun":(8,4,13), "08/jun":(10,4,15)},
    "FBM-S Meli Pro":                            {"30/mar":(0,2,2), "06/abr":(9,2,12), "13/abr":(14,6,20), "20/abr":(17,0,20), "27/abr":(13,1,18), "04/mai":(9,6,16), "11/mai":(19,1,22), "18/mai":(21,2,26), "25/mai":(18,5,29), "01/jun":(15,2,17), "08/jun":(11,1,13)},
    "FBM-S Seller Dev":                          {"30/mar":(73,23,104), "06/abr":(74,24,115), "13/abr":(68,24,101), "20/abr":(85,29,121), "27/abr":(79,25,107), "04/mai":(69,24,104), "11/mai":(74,27,104), "18/mai":(73,24,104), "25/mai":(60,20,90), "01/jun":(75,28,110), "08/jun":(78,30,124)},
    "ME Vendedor Mature":                        {"30/mar":(170,28,219), "06/abr":(187,41,246), "13/abr":(111,22,143), "20/abr":(73,17,93), "27/abr":(48,11,65), "04/mai":(75,10,89), "11/mai":(53,16,72), "18/mai":(74,10,91), "25/mai":(67,14,85), "01/jun":(50,5,58), "08/jun":(53,8,68)},
    "ME Vendedor Meli Pro":                      {"30/mar":(10,6,17), "06/abr":(24,6,30), "13/abr":(76,4,83), "20/abr":(104,10,120), "27/abr":(110,4,120), "04/mai":(140,11,157), "11/mai":(114,12,134), "18/mai":(127,12,143), "25/mai":(95,9,107), "01/jun":(64,5,70), "08/jun":(114,9,131)},
    "ME Vendedor Seller Dev":                    {"30/mar":(508,79,635), "06/abr":(838,112,1053), "13/abr":(577,89,741), "20/abr":(529,76,654), "27/abr":(583,67,710), "04/mai":(739,108,940), "11/mai":(748,64,887), "18/mai":(742,73,879), "25/mai":(759,70,911), "01/jun":(827,82,971), "08/jun":(756,77,912)},
    "Otros CV":                                  {"30/mar":(139,36,195), "06/abr":(181,63,259), "13/abr":(158,56,230), "20/abr":(183,68,260), "27/abr":(159,44,223), "04/mai":(165,47,231), "11/mai":(223,87,328), "18/mai":(160,76,256), "25/mai":(167,77,263), "01/jun":(74,51,135), "08/jun":(70,47,124)},
    "PCF Vendedor Mature":                       {"30/mar":(68,14,91), "06/abr":(97,24,131), "13/abr":(51,19,81), "20/abr":(21,9,34), "27/abr":(23,7,33), "04/mai":(30,8,42), "11/mai":(18,8,28), "18/mai":(34,9,44), "25/mai":(19,5,28), "01/jun":(17,6,25), "08/jun":(19,10,33)},
    "PCF Vendedor Meli Pro":                     {"30/mar":(4,3,7), "06/abr":(13,3,19), "13/abr":(67,12,89), "20/abr":(101,14,131), "27/abr":(91,12,111), "04/mai":(113,20,157), "11/mai":(111,10,130), "18/mai":(118,18,145), "25/mai":(116,13,137), "01/jun":(61,11,77), "08/jun":(75,8,87)},
    "PCF Vendedor Seller Dev":                   {"30/mar":(84,23,125), "06/abr":(98,29,136), "13/abr":(95,28,137), "20/abr":(82,30,129), "27/abr":(81,26,119), "04/mai":(94,28,138), "11/mai":(82,29,123), "18/mai":(75,32,116), "25/mai":(79,28,122), "01/jun":(100,23,140), "08/jun":(110,31,151)},
    "PDD DS&XD - Vendedor":                      {"30/mar":(136,106,275), "06/abr":(113,95,236), "13/abr":(135,107,261), "20/abr":(115,76,214), "27/abr":(117,96,228), "04/mai":(122,104,268), "11/mai":(113,107,243), "18/mai":(126,97,248), "25/mai":(122,112,266), "01/jun":(141,89,250), "08/jun":(121,85,234)},
    "PDD FBM - Vendedor":                        {"30/mar":(45,16,63), "06/abr":(40,18,65), "13/abr":(38,25,72), "20/abr":(43,25,74), "27/abr":(39,18,64), "04/mai":(31,26,61), "11/mai":(33,20,58), "18/mai":(59,25,91), "25/mai":(64,19,91), "01/jun":(56,25,85), "08/jun":(34,16,62)},
    "PDD Fotos - Vendedor":                      {"30/mar":(9,5,15), "06/abr":(7,5,12), "13/abr":(8,8,17), "20/abr":(10,7,20), "27/abr":(7,2,12), "04/mai":(14,8,24), "11/mai":(7,3,11), "18/mai":(12,4,16), "25/mai":(8,6,16), "01/jun":(5,3,9), "08/jun":(4,0,5)},
    "PDD MP,FLEX & CBT - Vendedor":              {"30/mar":(14,7,24), "06/abr":(16,9,28), "13/abr":(21,11,39), "20/abr":(8,10,19), "27/abr":(19,13,38), "04/mai":(21,9,31), "11/mai":(25,9,38), "18/mai":(20,9,30), "25/mai":(16,11,30), "01/jun":(18,9,32), "08/jun":(18,15,36)},
    "PNR ME - Vendedor":                         {"30/mar":(18,9,30), "06/abr":(21,15,38), "13/abr":(23,10,37), "20/abr":(63,41,110), "27/abr":(38,25,68), "04/mai":(26,18,48), "11/mai":(22,26,59), "18/mai":(23,10,37), "25/mai":(33,16,55), "01/jun":(38,20,64), "08/jun":(23,15,40)},
    "PNR MP - Vendedor":                         {"30/mar":(33,15,56), "06/abr":(54,16,74), "13/abr":(32,13,49), "20/abr":(28,25,57), "27/abr":(38,13,62), "04/mai":(30,18,54), "11/mai":(30,17,56), "18/mai":(24,9,42), "25/mai":(29,21,59), "01/jun":(20,12,43), "08/jun":(29,20,55)},
    "Partners":                                  {"30/mar":(448,77,574), "06/abr":(460,76,587), "13/abr":(575,85,725), "20/abr":(567,85,719), "27/abr":(548,99,717), "04/mai":(516,74,642), "11/mai":(588,86,740), "18/mai":(520,70,660), "25/mai":(505,65,637), "01/jun":(441,65,553), "08/jun":(494,75,624)},
    "Post Venta Mature":                         {"30/mar":(88,20,114), "06/abr":(89,15,117), "13/abr":(76,11,97), "20/abr":(46,6,58), "27/abr":(42,8,57), "04/mai":(40,8,53), "11/mai":(62,3,71), "18/mai":(50,10,66), "25/mai":(61,7,72), "01/jun":(42,1,44), "08/jun":(54,9,67)},
    "Post Venta Meli Pro":                       {"30/mar":(8,0,9), "06/abr":(25,2,29), "13/abr":(104,5,112), "20/abr":(149,1,152), "27/abr":(135,7,150), "04/mai":(200,9,213), "11/mai":(179,8,191), "18/mai":(211,8,227), "25/mai":(178,10,193), "01/jun":(130,5,139), "08/jun":(193,5,201)},
    "Post Venta Seller Dev":                     {"30/mar":(176,39,233), "06/abr":(239,39,301), "13/abr":(194,23,233), "20/abr":(177,18,209), "27/abr":(176,20,219), "04/mai":(215,18,249), "11/mai":(194,24,235), "18/mai":(181,19,210), "25/mai":(204,12,236), "01/jun":(252,21,293), "08/jun":(235,24,284)},
    "Publicaciones Mature":                      {"30/mar":(61,13,87), "06/abr":(72,12,101), "13/abr":(37,14,57), "20/abr":(25,3,30), "27/abr":(19,1,22), "04/mai":(22,4,30), "11/mai":(27,5,32), "18/mai":(21,3,29), "25/mai":(19,5,24), "01/jun":(21,1,23), "08/jun":(21,2,25)},
    "Publicaciones Meli Pro":                    {"30/mar":(6,1,8), "06/abr":(6,1,8), "13/abr":(37,4,44), "20/abr":(59,4,64), "27/abr":(81,5,89), "04/mai":(96,5,104), "11/mai":(89,3,92), "18/mai":(88,1,90), "25/mai":(87,4,95), "01/jun":(55,1,64), "08/jun":(43,1,44)},
    "Publicaciones Seller Dev":                  {"30/mar":(502,88,653), "06/abr":(607,103,769), "13/abr":(453,80,587), "20/abr":(398,76,512), "27/abr":(381,88,517), "04/mai":(370,100,520), "11/mai":(370,81,492), "18/mai":(377,96,509), "25/mai":(476,104,649), "01/jun":(435,83,579), "08/jun":(458,97,601)},
}
