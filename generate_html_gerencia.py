...
S1_LABEL  = "11/mai – 17/mai"
S2_LABEL  = "04/mai – 10/mai"
VIG_LABEL = "18/mai – 19/mai"
M1_LABEL  = "Maio 2026"
M2_LABEL  = "Abril 2026"
...
# ═══════════════════════════════════════════════════════════════
weekly_driver = {
    "CBT":                                       {"S2":(85,12,100), "S1":(59,14,75)},
    "Experiencia Impositiva Mature":             {"S2":(5,0,5), "S1":(4,1,5)},
    "Experiencia Impositiva Meli Pro":           {"S2":(2,1,3), "S1":(4,0,5)},
    "Experiencia Impositiva Seller Dev":         {"S2":(72,36,116), "S1":(67,29,103)},
    "FBM-S Mature":                              {"S2":(9,4,20), "S1":(12,11,25)},
    "FBM-S Meli Pro":                            {"S2":(9,6,16), "S1":(19,1,22)},
    "FBM-S Seller Dev":                          {"S2":(69,24,104), "S1":(74,27,104)},
    "ME Vendedor Mature":                        {"S2":(75,10,89), "S1":(53,16,72)},
    "ME Vendedor Meli Pro":                      {"S2":(140,11,157), "S1":(114,12,134)},
    "ME Vendedor Seller Dev":                    {"S2":(739,108,940), "S1":(748,64,887)},
    "Otros CV":                                  {"S2":(165,47,231), "S1":(223,88,329)},
    "PCF Vendedor Mature":                       {"S2":(30,8,42), "S1":(18,8,28)},
    "PCF Vendedor Meli Pro":                     {"S2":(113,20,157), "S1":(111,10,130)},
    "PCF Vendedor Seller Dev":                   {"S2":(94,28,138), "S1":(82,29,123)},
    "PDD DS&XD - Vendedor":                      {"S2":(122,104,268), "S1":(113,108,244)},
    "PDD FBM - Vendedor":                        {"S2":(31,26,61), "S1":(33,20,58)},
    "PDD Fotos - Vendedor":                      {"S2":(14,8,24), "S1":(7,3,11)},
    "PDD MP,FLEX & CBT - Vendedor":              {"S2":(21,9,31), "S1":(25,9,38)},
    "PNR ME - Vendedor":                         {"S2":(26,18,48), "S1":(22,26,59)},
    "PNR MP - Vendedor":                         {"S2":(30,18,54), "S1":(31,17,57)},
    "Partners":                                  {"S2":(516,74,642), "S1":(588,86,740)},
    "Post Venta Mature":                         {"S2":(40,8,53), "S1":(62,3,71)},
    "Post Venta Meli Pro":                       {"S2":(200,9,213), "S1":(179,8,191)},
    "Post Venta Seller Dev":                     {"S2":(215,18,249), "S1":(194,24,235)},
    "Publicaciones Mature":                      {"S2":(22,4,30), "S1":(27,5,32)},
    "Publicaciones Meli Pro":                    {"S2":(96,5,104), "S1":(89,3,92)},
    "Publicaciones Seller Dev":                  {"S2":(370,100,520), "S1":(370,81,492)},
}
...
drivers_vigente = {
    ...
    "Experiencia Impositiva Meli Pro":           (1,1,3),
    "Experiencia Impositiva Seller Dev":         (14,3,17),
    "FBM-S Mature":                              (2,0,3),
    "FBM-S Meli Pro":                            (6,0,7),
    "FBM-S Seller Dev":                          (7,3,11),
    "ME Vendedor Mature":                        (13,4,19),
    "ME Vendedor Meli Pro":                      (26,4,30),
    "ME Vendedor Seller Dev":                    (125,10,149),
    "Otros CV":                                  (32,16,51),
    "PCF Vendedor Mature":                       (7,1,8),
    "PCF Vendedor Meli Pro":                     (22,4,28),
    "PCF Vendedor Seller Dev":                   (9,9,18),
    "PDD DS&XD - Vendedor":                      (27,15,47),
    "PDD FBM - Vendedor":                        (8,6,14),
    "PDD Fotos - Vendedor":                      (3,0,3),
    "PDD MP,FLEX & CBT - Vendedor":              (2,0,2),
    "PNR ME - Vendedor":                         (2,2,4),
    "PNR MP - Vendedor":                         (4,2,7),
    "Partners":                                  (122,19,158),
    "Post Venta Mature":                         (10,2,13),
    "Post Venta Meli Pro":                       (51,3,54),
    "Post Venta Seller Dev":                     (39,4,45),
    "Publicaciones Mature":                      (3,1,5),
    "Publicaciones Meli Pro":                    (17,1,18),
    "Publicaciones Seller Dev":                  (54,14,74),
}
...
WEEK_LABELS  = ["30/mar", "06/abr", "13/abr", "20/abr", "27/abr", "04/mai", "11/mai"]
...
weekly_history = {
    "CBT":                                       {"30/mar":(75,9,86), "06/abr":(87,12,101), "13/abr":(87,15,102), "20/abr":(77,16,96), "27/abr":(56,10,67), "04/mai":(85,12,100), "11/mai":(59,14,75)},
    "Experiencia Impositiva Mature":             {"30/mar":(12,5,20), "06/abr":(9,3,13), "13/abr":(6,2,8), "20/abr":(2,0,4), "27/abr":(5,0,5), "04/mai":(5,0,5), "11/mai":(4,1,5)},
    "Experiencia Impositiva Meli Pro":           {"30/mar":(2,1,3), "06/abr":(1,0,2), "13/abr":(2,1,4), "20/abr":(3,0,3), "27/abr":(5,2,7), "04/mai":(2,1,3), "11/mai":(4,0,5)},
    "Experiencia Impositiva Seller Dev":         {"30/mar":(66,25,100), "06/abr":(150,36,208), "13/abr":(112,33,160), "20/abr":(57,23,88), "27/abr":(50,13,70), "04/mai":(72,36,116), "11/mai":(67,29,103)},
    "FBM-S Mature":                              {"30/mar":(30,13,48), "06/abr":(28,7,40), "13/abr":(23,4,29), "20/abr":(17,4,21), "27/abr":(13,3,20), "04/mai":(9,4,20), "11/mai":(12,11,25)},
    "FBM-S Meli Pro":                            {"30/mar":(0,2,2), "06/abr":(9,2,12), "13/abr":(14,6,20), "20/abr":(17,0,20), "27/abr":(13,1,18), "04/mai":(9,6,16), "11/mai":(19,1,22)},
    "FBM-S Seller Dev":                          {"30/mar":(73,23,104), "06/abr":(74,24,115), "13/abr":(68,24,101), "20/abr":(85,29,121), "27/abr":(79,25,107), "04/mai":(69,24,104), "11/mai":(74,27,104)},
    "ME Vendedor Mature":                        {"30/mar":(170,28,219), "06/abr":(187,41,246), "13/abr":(111,22,143), "20/abr":(73,17,93), "27/abr":(48,11,65), "04/mai":(75,10,89), "11/mai":(53,16,72)},
    "ME Vendedor Meli Pro":                      {"30/mar":(10,6,17), "06/abr":(24,6,30), "13/abr":(76,4,83), "20/abr":(104,10,120), "27/abr":(110,4,120), "04/mai":(140,11,157), "11/mai":(114,12,134)},
    "ME Vendedor Seller Dev":                    {"30/mar":(508,79,635), "06/abr":(838,112,1053), "13/abr":(577,89,741), "20/abr":(529,76,654), "27/abr":(583,67,710), "04/mai":(739,108,940), "11/mai":(748,64,887)},
    "Otros CV":                                  {"30/mar":(139,36,195), "06/abr":(181,63,259), "13/abr":(158,56,230), "20/abr":(183,68,260), "27/abr":(159,44,223), "04/mai":(165,47,231), "11/mai":(223,87,328)},
    "PCF Vendedor Mature":                       {"30/mar":(68,14,91), "06/abr":(97,24,131), "13/abr":(51,19,81), "20/abr":(21,9,34), "27/abr":(23,7,33), "04/mai":(30,8,42), "11/mai":(18,8,28)},
    "PCF Vendedor Meli Pro":                     {"30/mar":(4,3,7), "06/abr":(13,3,19), "13/abr":(67,12,89), "20/abr":(101,14,131), "27/abr":(91,12,111), "04/mai":(113,20,157), "11/mai":(111,10,130)},
    "PCF Vendedor Seller Dev":                   {"30/mar":(84,23,125), "06/abr":(98,29,136), "13/abr":(95,28,137), "20/abr":(82,30,129), "27/abr":(81,26,119), "04/mai":(94,28,138), "11/mai":(82,29,123)},
    "PDD DS&XD - Vendedor":                      {"30/mar":(136,106,275), "06/abr":(113,95,236), "13/abr":(135,107,261), "20/abr":(115,76,214), "27/abr":(117,96,228), "04/mai":(122,104,268), "11/mai":(113,107,243)},
    "PDD FBM - Vendedor":                        {"30/mar":(45,16,63), "06/abr":(40,18,65), "13/abr":(38,25,72), "20/abr":(43,25,74), "27/abr":(39,18,64), "04/mai":(31,26,61), "11/mai":(33,20,58)},
    "PDD Fotos - Vendedor":                      {"30/mar":(9,5,15), "06/abr":(7,5,12), "13/abr":(8,8,17), "20/abr":(10,7,20), "27/abr":(7,2,12), "04/mai":(14,8,24), "11/mai":(7,3,11)},
    "PDD MP,FLEX & CBT - Vendedor":              {"30/mar":(14,7,24), "06/abr":(16,9,28), "13/abr":(21,11,39), "20/abr":(8,10,19), "27/abr":(19,13,38), "04/mai":(21,9,31), "11/mai":(25,9,38)},
    "PNR ME - Vendedor":                         {"30/mar":(18,9,30), "06/abr":(21,15,38), "13/abr":(23,10,37), "20/abr":(63,41,110), "27/abr":(38,25,68), "04/mai":(26,18,48), "11/mai":(22,26,59)},
    "PNR MP - Vendedor":                         {"30/mar":(33,15,56), "06/abr":(54,16,74), "13/abr":(32,13,49), "20/abr":(28,25,57), "27/abr":(38,13,62), "04/mai":(30,18,54), "11/mai":(30,17,56)},
    "Partners":                                  {"30/mar":(448,77,574), "06/abr":(460,76,587), "13/abr":(575,85,725), "20/abr":(567,85,719), "27/abr":(548,99,717), "04/mai":(516,74,642), "11/mai":(588,86,740)},
    "Post Venta Mature":                         {"30/mar":(88,20,114), "06/abr":(89,15,117), "13/abr":(76,11,97), "20/abr":(46,6,58), "27/abr":(42,8,57), "04/mai":(40,8,53), "11/mai":(62,3,71)},
    "Post Venta Meli Pro":                       {"30/mar":(8,0,9), "06/abr":(25,2,29), "13/abr":(104,5,112), "20/abr":(149,1,152), "27/abr":(135,7,150), "04/mai":(200,9,213), "11/mai":(179,8,191)},
    "Post Venta Seller Dev":                     {"30/mar":(176,39,233), "06/abr":(239,39,301), "13/abr":(194,23,233), "20/abr":(177,18,209), "27/abr":(176,20,219), "04/mai":(215,18,249), "11/mai":(194,24,235)},
    "Publicaciones Mature":                      {"30/mar":(61,13,87), "06/abr":(72,12,101), "13/abr":(37,14,57), "20/abr":(25,3,30), "27/abr":(19,1,22), "04/mai":(22,4,30), "11/mai":(27,5,32)},
    "Publicaciones Meli Pro":                    {"30/mar":(6,1,8), "06/abr":(6,1,8), "13/abr":(37,4,44), "20/abr":(59,4,64), "27/abr":(81,5,89), "04/mai":(96,5,104), "11/mai":(89,3,92)},
    "Publicaciones Seller Dev":                  {"30/mar":(502,88,653), "06/abr":(607,103,769), "13/abr":(453,80,587), "20/abr":(398,76,512), "27/abr":(381,88,517), "04/mai":(370,100,520), "11/mai":(370,81,492)},
}
