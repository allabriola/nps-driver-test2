...
weekly_history = {
    ...
    "Experiencia Impositiva Meli Pro":           {"30/mar":(2,1,3), "06/abr":(1,0,2), "13/abr":(2,1,4), "20/abr":(3,0,3), "27/abr":(5,2,7), "04/mai":(2,1,3), "11/mai":(4,0,5), "18/mai":(7,2,10), "25/mai":(0,3,4), "01/jun":(5,4,9), "08/jun":(5,0,5), "15/jun": (6, 2, 8)},
    "Experiencia Impositiva Seller Dev":         {"30/mar":(66,25,100), "06/abr":(150,36,208), "13/abr":(112,33,160), "20/abr":(57,23,88), "27/abr":(50,13,70), "04/mai":(72,36,116), "11/mai":(67,30,104), "18/mai":(89,20,118), "25/mai":(106,19,139), "01/jun":(75,17,97), "08/jun":(105,31,147), "15/jun": (84, 14, 113)},
    "FBM-S Mature":                              {"30/mar":(30,13,48), "06/abr":(28,7,40), "13/abr":(23,4,29), "20/abr":(17,4,21), "27/abr":(13,3,20), "04/mai":(9,4,20), "11/mai":(12,11,25), "18/mai":(6,3,10), "25/mai":(12,2,16), "01/jun":(9,5,16), "08/jun":(10,4,15), "15/jun": (13, 6, 25)},
    "FBM-S Meli Pro":                            {"30/mar":(0,2,2), "06/abr":(9,2,12), "13/abr":(14,6,20), "20/abr":(17,0,20), "27/abr":(13,1,18), "04/mai":(9,6,16), "11/mai":(19,1,22), "18/mai":(21,2,26), "25/mai":(18,5,29), "01/jun":(16,3,19), "08/jun":(11,1,13), "15/jun": (24, 4, 28)},
    "FBM-S Seller Dev":                          {"30/mar":(73,23,104), "06/abr":(74,24,115), "13/abr":(68,24,101), "20/abr":(85,29,121), "27/abr":(79,25,107), "04/mai":(69,24,104), "11/mai":(74,27,104), "18/mai":(73,24,104), "25/mai":(60,20,90), "01/jun":(73,26,105), "08/jun":(78,30,124), "15/jun": (58, 24, 98)},
    "ME Vendedor Mature":                        {"30/mar":(170,28,219), "06/abr":(187,41,246), "13/abr":(111,22,143), "20/abr":(73,17,93), "27/abr":(48,11,65), "04/mai":(75,10,89), "11/mai":(53,16,72), "18/mai":(74,10,91), "25/mai":(67,14,85), "01/jun":(69,6,82), "08/jun":(53,8,68), "15/jun": (81, 18, 114)},
    "ME Vendedor Meli Pro":                      {"30/mar":(10,6,17), "06/abr":(24,6,30), "13/abr":(76,4,83), "20/abr":(104,10,120), "27/abr":(110,4,120), "04/mai":(140,11,157), "11/mai":(114,12,134), "18/mai":(127,12,143), "25/mai":(95,9,107), "01/jun":(93,10,105), "08/jun":(114,9,131), "15/jun": (126, 13, 147)},
    "ME Vendedor Seller Dev":                    {"30/mar":(508,79,635), "06/abr":(838,112,1053), "13/abr":(577,89,741), "20/abr":(529,76,654), "27/abr":(583,67,710), "04/mai":(739,108,940), "11/mai":(748,64,887), "18/mai":(742,74,880), "25/mai":(759,70,911), "01/jun":(779,76,912), "08/jun":(756,77,912), "15/jun": (571, 69, 707)},
    ...
    "PCF Vendedor Mature":                       {"30/mar":(68,14,91), "06/abr":(97,24,131), "13/abr":(51,19,81), "20/abr":(21,9,34), "27/abr":(23,7,33), "04/mai":(30,8,42), "11/mai":(18,8,28), "18/mai":(34,9,44), "25/mai":(19,5,28), "01/jun":(20,7,32), "08/jun":(19,10,33), "15/jun": (17, 8, 28)},
    "PCF Vendedor Meli Pro":                     {"30/mar":(4,3,7), "06/abr":(13,3,19), "13/abr":(67,12,89), "20/abr":(101,14,131), "27/abr":(91,12,111), "04/mai":(113,20,157), "11/mai":(111,10,130), "18/mai":(118,18,145), "25/mai":(116,13,137), "01/jun":(85,15,106), "08/jun":(75,8,87), "15/jun": (94, 20, 117)},
    "PCF Vendedor Seller Dev":                   {"30/mar":(84,23,125), "06/abr":(98,29,136), "13/abr":(95,28,137), "20/abr":(82,30,129), "27/abr":(81,26,119), "04/mai":(94,28,138), "11/mai":(82,29,123), "18/mai":(75,32,116), "25/mai":(79,29,123), "01/jun":(73,18,104), "08/jun":(110,31,151), "15/jun": (90, 29, 132)},
    "PDD DS&XD - Vendedor":                      {"30/mar":(136,106,275), "06/abr":(113,95,236), "13/abr":(135,107,261), "20/abr":(115,76,214), "27/abr":(118,96,229), "04/mai":(122,104,268), "11/mai":(115,111,249), "18/mai":(129,100,254), "25/mai":(125,115,275), "01/jun":(145,91,257), "08/jun":(121,85,234), "15/jun": (103, 93, 221)},
    "PDD FBM - Vendedor":                        {"30/mar":(45,16,63), "06/abr":(40,18,65), "13/abr":(38,25,72), "20/abr":(43,25,74), "27/abr":(39,18,64), "04/mai":(31,26,61), "11/mai":(33,23,61), "18/mai":(62,25,95), "25/mai":(67,20,95), "01/jun":(57,25,86), "08/jun":(34,16,62), "15/jun": (40, 22, 66)},
    ...
    "PDD MP,FLEX & CBT - Vendedor":              {"30/mar":(14,7,24), "06/abr":(16,9,28), "13/abr":(21,11,39), "20/abr":(8,10,19), "27/abr":(19,13,38), "04/mai":(21,9,31), "11/mai":(25,9,38), "18/mai":(20,10,31), "25/mai":(17,12,32), "01/jun":(18,11,34), "08/jun":(18,15,36), "15/jun": (16, 13, 33)},
    "PNR ME - Vendedor":                         {"30/mar":(18,9,30), "06/abr":(21,15,38), "13/abr":(23,10,37), "20/abr":(63,41,110), "27/abr":(38,25,68), "04/mai":(26,18,48), "11/mai":(22,26,59), "18/mai":(24,11,39), "25/mai":(35,16,57), "01/jun":(40,20,67), "08/jun":(23,15,40), "15/jun": (20, 17, 40)},
    "PNR MP - Vendedor":                         {"30/mar":(33,15,56), "06/abr":(54,16,74), "13/abr":(32,13,49), "20/abr":(28,25,57), "27/abr":(38,13,62), "04/mai":(30,18,54), "11/mai":(33,17,59), "18/mai":(26,9,44), "25/mai":(30,21,62), "01/jun":(21,12,44), "08/jun":(29,20,55), "15/jun": (34, 12, 51)},
    "Partners":                                  {"30/mar":(448,77,574), "06/abr":(460,76,587), "13/abr":(575,85,725), "20/abr":(567,85,719), "27/abr":(548,99,717), "04/mai":(516,74,642), "11/mai":(588,87,741), "18/mai":(520,70,660), "25/mai":(505,65,637), "01/jun":(442,65,554), "08/jun":(494,75,624), "15/jun": (664, 94, 840)},
    "Post Venta Mature":                         {"30/mar":(88,20,114), "06/abr":(89,15,117), "13/abr":(76,11,97), "20/abr":(46,6,58), "27/abr":(42,8,57), "04/mai":(40,8,53), "11/mai":(62,3,71), "18/mai":(50,10,66), "25/mai":(61,7,72), "01/jun":(51,1,53), "08/jun":(54,9,67), "15/jun": (59, 2, 64)},
    "Post Venta Meli Pro":                       {"30/mar":(8,0,9), "06/abr":(25,2,29), "13/abr":(104,5,112), "20/abr":(149,1,152), "27/abr":(135,7,150), "04/mai":(200,9,213), "11/mai":(179,8,191), "18/mai":(211,8,227), "25/mai":(178,10,193), "01/jun":(192,9,206), "08/jun":(193,5,201), "15/jun": (275, 8, 285)},
    "Post Venta Seller Dev":                     {"30/mar":(176,39,233), "06/abr":(239,39,301), "13/abr":(194,23,233), "20/abr":(177,18,209), "27/abr":(176,20,219), "04/mai":(215,18,249), "11/mai":(194,24,235), "18/mai":(181,19,210), "25/mai":(204,12,236), "01/jun":(181,18,218), "08/jun":(235,24,284), "15/jun": (196, 16, 227)},
    "Publicaciones Mature":                      {"30/mar":(61,13,87), "06/abr":(72,12,101), "13/abr":(37,14,57), "20/abr":(25,3,30), "27/abr":(19,1,22), "04/mai":(22,4,30), "11/mai":(27,5,32), "18/mai":(21,3,29), "25/mai":(19,5,24), "01/jun":(27,4,32), "08/jun":(21,2,25), "15/jun": (19, 3, 25)},
    "Publicaciones Meli Pro":                    {"30/mar":(6,1,8), "06/abr":(6,1,8), "13/abr":(37,4,44), "20/abr":(59,4,64), "27/abr":(81,5,89), "04/mai":(96,5,104), "11/mai":(89,3,92), "18/mai":(88,1,90), "25/mai":(87,4,95), "01/jun":(68,3,80), "08/jun":(43,1,44), "15/jun": (42, 4, 51)},
    "Publicaciones Seller Dev":                  {"30/mar":(502,88,653), "06/abr":(607,103,769), "13/abr":(453,80,587), "20/abr":(398,76,512), "27/abr":(381,88,517), "04/mai":(370,100,520), "11/mai":(371,81,493), "18/mai":(378,96,510), "25/mai":(476,104,649), "01/jun":(416,78,554), "08/jun":(458,97,601), "15/jun": (416, 66, 526)},
}
