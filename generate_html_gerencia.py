...
S1_LABEL  = "29/jun – 05/jul"
S2_LABEL  = "22/jun – 28/jun"
VIG_LABEL = "06/jul – 06/jul"
M1_LABEL  = "Julho 2026"
M2_LABEL  = "Junho 2026"
...
# ═══════════════════════════════════════════════════════════════
weekly_driver = {
    "CBT":                                       {"S2":(84,7,94), "S1":(111,19,134)},
    "Experiencia Impositiva Mature":             {"S2":(2,4,7), "S1":(2,0,3)},
    "Experiencia Impositiva Meli Pro":           {"S2":(5,0,5), "S1":(0,0,0)},
    "Experiencia Impositiva Seller Dev":         {"S2":(74,19,102), "S1":(63,16,85)},
    "FBM-S Mature":                              {"S2":(19,9,30), "S1":(10,6,17)},
    "FBM-S Meli Pro":                            {"S2":(24,2,28), "S1":(12,2,15)},
    "FBM-S Seller Dev":                          {"S2":(78,16,102), "S1":(45,24,76)},
    "ME Vendedor Mature":                        {"S2":(102,14,129), "S1":(67,9,84)},
    "ME Vendedor Meli Pro":                      {"S2":(133,20,163), "S1":(91,8,105)},
    "ME Vendedor Seller Dev":                    {"S2":(608,74,743), "S1":(529,66,641)},
    "Otros CV":                                  {"S2":(61,24,90), "S1":(49,26,77)},
    "PCF Vendedor Mature":                       {"S2":(35,13,54), "S1":(15,6,24)},
    "PCF Vendedor Meli Pro":                     {"S2":(82,15,103), "S1":(53,6,64)},
    "PCF Vendedor Seller Dev":                   {"S2":(86,22,123), "S1":(73,29,109)},
    "PDD DS&XD - Vendedor":                      {"S2":(97,84,202), "S1":(101,76,191)},
    "PDD FBM - Vendedor":                        {"S2":(34,11,51), "S1":(23,15,48)},
    "PDD Fotos - Vendedor":                      {"S2":(0,2,2), "S1":(2,2,4)},
    "PDD MP,FLEX & CBT - Vendedor":              {"S2":(10,9,27), "S1":(13,7,24)},
    "PNR ME - Vendedor":                         {"S2":(23,8,32), "S1":(11,9,22)},
    "PNR MP - Vendedor":                         {"S2":(30,9,44), "S1":(36,17,57)},
    "Partners":                                  {"S2":(709,95,882), "S1":(722,91,918)},
    "Post Venta Mature":                         {"S2":(53,3,63), "S1":(35,3,40)},
    "Post Venta Meli Pro":                       {"S2":(251,14,266), "S1":(121,8,133)},
    "Post Venta Seller Dev":                     {"S2":(180,15,217), "S1":(144,19,179)},
    "Publicaciones Mature":                      {"S2":(27,4,38), "S1":(17,1,19)},
    "Publicaciones Meli Pro":                    {"S2":(65,1,67), "S1":(37,4,43)},
    "Publicaciones Seller Dev":                  {"S2":(403,63,521), "S1":(356,67,465)},
}

monthly_driver = {
    "CBT":                                       {"M2":(357,43,412), "M1":(105,15,123)},
    "Experiencia Impositiva Mature":             {"M2":(13,7,21), "M1":(2,0,3)},
    "Experiencia Impositiva Meli Pro":           {"M2":(21,8,29), "M1":(0,0,0)},
    "Experiencia Impositiva Seller Dev":         {"M2":(346,87,474), "M1":(73,9,87)},
    "FBM-S Mature":                              {"M2":(58,25,95), "M1":(8,6,15)},
    "FBM-S Meli Pro":                            {"M2":(80,12,98), "M1":(12,0,12)},
    "FBM-S Seller Dev":                          {"M2":(292,104,439), "M1":(44,23,76)},
    "ME Vendedor Mature":                        {"M2":(339,53,438), "M1":(58,7,74)},
    "ME Vendedor Meli Pro":                      {"M2":(543,56,631), "M1":(61,11,74)},
    "ME Vendedor Seller Dev":                    {"M2":(2907,318,3504), "M1":(519,55,629)},
    "Otros CV":                                  {"M2":(281,167,480), "M1":(34,18,54)},
    "PCF Vendedor Mature":                       {"M2":(110,41,171), "M1":(16,6,24)},
    "PCF Vendedor Meli Pro":                     {"M2":(385,59,469), "M1":(27,10,40)},
    "PCF Vendedor Seller Dev":                   {"M2":(347,111,508), "M1":(65,20,92)},
    "PDD DS&XD - Vendedor":                      {"M2":(502,382,983), "M1":(91,79,188)},
    "PDD FBM - Vendedor":                        {"M2":(170,82,278), "M1":(25,7,45)},
    "PDD Fotos - Vendedor":                      {"M2":(13,6,22), "M1":(2,3,5)},
    "PDD MP,FLEX & CBT - Vendedor":              {"M2":(67,49,138), "M1":(13,6,22)},
    "PNR ME - Vendedor":                         {"M2":(112,64,190), "M1":(13,11,27)},
    "PNR MP - Vendedor":                         {"M2":(132,62,223), "M1":(23,10,37)},
    "Partners":                                  {"M2":(2527,355,3174), "M1":(640,77,810)},
    "Post Venta Mature":                         {"M2":(240,17,272), "M1":(25,3,30)},
    "Post Venta Meli Pro":                       {"M2":(1038,46,1099), "M1":(75,4,81)},
    "Post Venta Seller Dev":                     {"M2":(784,71,941), "M1":(104,20,134)},
    "Publicaciones Mature":                      {"M2":(106,14,134), "M1":(11,1,14)},
    "Publicaciones Meli Pro":                    {"M2":(245,11,272), "M1":(29,2,32)},
    "Publicaciones Seller Dev":                  {"M2":(1793,329,2338), "M1":(309,53,397)},
}
...
drivers_vigente = {
    ...
    "Experiencia Impositiva Seller Dev":         (18,1,19),
    "FBM-S Mature":                              (2,1,3),
    "FBM-S Meli Pro":                            (2,0,2),
    "FBM-S Seller Dev":                          (10,7,19),
    "ME Vendedor Mature":                        (16,2,21),
    "ME Vendedor Meli Pro":                      (18,6,24),
    "ME Vendedor Seller Dev":                    (221,15,262),
    "Otros CV":                                  (3,3,7),
    "PCF Vendedor Mature":                       (6,2,9),
    "PCF Vendedor Meli Pro":                     (6,5,12),
    "PCF Vendedor Seller Dev":                   (11,3,16),
    "PDD DS&XD - Vendedor":                      (20,23,51),
    "PDD FBM - Vendedor":                        (6,0,9),
    "PDD Fotos - Vendedor":                      (1,1,2),
    "PDD MP,FLEX & CBT - Vendedor":              (3,0,3),
    "PNR ME - Vendedor":                         (6,4,11),
    "PNR MP - Vendedor":                         (4,2,8),
    "Partners":                                  (133,12,163),
    "Post Venta Mature":                         (4,1,5),
    "Post Venta Meli Pro":                       (28,0,28),
    "Post Venta Seller Dev":                     (14,7,22),
    "Publicaciones Mature":                      (2,0,3),
    "Publicaciones Meli Pro":                    (12,0,12),
    "Publicaciones Seller Dev":                  (62,12,79),
}
...
WEEK_LABELS  = ["11/mai", "18/mai", "25/mai", "01/jun", "08/jun", "15/jun", "22/jun", "29/jun"]

monthly_history = {
    "CBT":                                       {"Fev":(224,27,254), "Mar":(323,58,395), "Abr":(345,54,405), "Mai":(359,64,431), "Jun":(357,43,412), "Jul":(105,15,123)},
    ...
    "Experiencia Impositiva Seller Dev":         {"Fev":(350,86,477), "Mar":(312,108,469), "Abr":(404,113,572), "Mai":(344,111,494), "Jun":(346,87,474), "Jul":(73,9,87)},
    "FBM-S Mature":                              {"Fev":(135,61,216), "Mar":(130,45,203), "Abr":(100,28,140), "Mai":(39,20,71), "Jun":(58,25,95), "Jul":(8,6,15)},
    "FBM-S Meli Pro":                            {"Fev":(20,6,27), "Mar":(11,8,22), "Abr":(53,9,70), "Mai":(67,14,93), "Jun":(80,12,98), "Jul":(12,0,12)},
    "FBM-S Seller Dev":                          {"Fev":(340,109,501), "Mar":(347,125,524), "Abr":(344,114,500), "Mai":(291,101,423), "Jun":(292,104,439), "Jul":(44,23,76)},
    "ME Vendedor Mature":                        {"Fev":(779,171,1041), "Mar":(809,157,1092), "Abr":(504,103,652), "Mai":(271,50,340), "Jun":(339,53,438), "Jul":(58,7,74)},
    "ME Vendedor Meli Pro":                      {"Fev":(93,9,109), "Mar":(60,10,75), "Abr":(320,26,361), "Mai":(476,44,541), "Jun":(543,56,631), "Jul":(61,11,74)},
    "ME Vendedor Seller Dev":                    {"Fev":(2568,367,3195), "Mar":(2479,377,3133), "Abr":(2710,375,3392), "Mai":(3112,329,3763), "Jun":(2907,318,3504), "Jul":(519,55,629)},
    "Otros CV":                                  {"Fev":(844,241,1206), "Mar":(775,182,1047), "Abr":(754,244,1068), "Mai":(741,299,1118), "Jun":(281,167,480), "Jul":(34,18,54)},
    "PCF Vendedor Mature":                       {"Fev":(324,90,464), "Mar":(332,85,467), "Abr":(225,68,326), "Mai":(101,31,143), "Jun":(110,41,171), "Jul":(16,6,24)},
    "PCF Vendedor Meli Pro":                     {"Fev":(57,11,73), "Mar":(32,8,44), "Abr":(272,42,351), "Mai":(458,61,569), "Jun":(385,59,469), "Jul":(27,10,40)},
    "PCF Vendedor Seller Dev":                   {"Fev":(529,173,768), "Mar":(536,166,790), "Abr":(395,118,569), "Mai":(340,119,516), "Jun":(347,111,508), "Jul":(65,20,92)},
    "PDD DS&XD - Vendedor":                      {"Fev":(452,332,906), "Mar":(645,486,1280), "Abr":(533,409,1041), "Mai":(539,477,1147), "Jun":(502,382,983), "Jul":(91,79,188)},
    "PDD FBM - Vendedor":                        {"Fev":(101,40,160), "Mar":(193,89,306), "Abr":(167,90,285), "Mai":(212,102,341), "Jun":(170,82,278), "Jul":(25,7,45)},
    "PDD Fotos - Vendedor":                      {"Fev":(31,18,61), "Mar":(46,22,72), "Abr":(36,23,64), "Mai":(42,22,73), "Jun":(13,6,22), "Jul":(2,3,5)},
    "PDD MP,FLEX & CBT - Vendedor":              {"Fev":(75,61,151), "Mar":(87,58,166), "Abr":(62,43,122), "Mai":(92,47,149), "Jun":(67,49,138), "Jul":(13,6,22)},
    "PNR ME - Vendedor":                         {"Fev":(86,79,186), "Mar":(103,71,193), "Abr":(150,90,258), "Mai":(116,80,222), "Jun":(112,64,190), "Jul":(13,11,27)},
    "PNR MP - Vendedor":                         {"Fev":(147,88,258), "Mar":(140,90,266), "Abr":(156,71,251), "Mai":(138,73,250), "Jun":(132,62,223), "Jul":(23,10,37)},
    "Partners":                                  {"Fev":(1808,217,2198), "Mar":(2228,337,2806), "Abr":(2229,360,2847), "Mai":(2315,322,2919), "Jun":(2527,355,3174), "Jul":(640,77,810)},
    "Post Venta Mature":                         {"Fev":(363,85,493), "Mar":(392,76,520), "Abr":(298,53,389), "Mai":(216,28,265), "Jun":(240,17,272), "Jul":(25,3,30)},
    "Post Venta Meli Pro":                       {"Fev":(88,9,101), "Mar":(70,10,81), "Abr":(416,15,447), "Mai":(769,35,825), "Jun":(1038,46,1099), "Jul":(75,4,81)},
    "Post Venta Seller Dev":                     {"Fev":(983,209,1291), "Mar":(929,178,1186), "Abr":(857,116,1059), "Mai":(822,76,964), "Jun":(784,71,941), "Jul":(104,20,134)},
    "Publicaciones Mature":                      {"Fev":(286,47,362), "Mar":(258,51,345), "Abr":(185,36,256), "Mai":(90,17,116), "Jun":(106,14,134), "Jul":(11,1,14)},
    "Publicaciones Meli Pro":                    {"Fev":(34,2,40), "Mar":(18,7,26), "Abr":(185,15,208), "Mai":(360,13,381), "Jun":(245,11,272), "Jul":(29,2,32)},
    "Publicaciones Seller Dev":                  {"Fev":(2581,381,3231), "Mar":(2639,374,3309), "Abr":(2000,374,2600), "Mai":(1741,406,2357), "Jun":(1793,329,2338), "Jul":(309,53,397)},
}

weekly_history = {
    "CBT":                                       {"11/mai":(59,14,75), "18/mai":(98,23,122), "25/mai":(98,12,111), "01/jun":(75,12,90), "08/jun":(100,12,116), "15/jun":(73,8,82), "22/jun":(80,7,90), "29/jun":(111,19,134)},
    "Experiencia Impositiva Mature":             {"11/mai":(4,1,5), "18/mai":(2,1,3), "25/mai":(0,2,3), "01/jun":(4,2,6), "08/jun":(3,0,3), "15/jun":(4,1,5), "22/jun":(2,4,7), "29/jun":(2,0,3)},
    "Experiencia Impositiva Meli Pro":           {"11/mai":(4,0,5), "18/mai":(7,2,10), "25/mai":(0,3,4), "01/jun":(5,4,9), "08/jun":(5,2,7), "15/jun":(6,2,8), "22/jun":(5,0,5), "29/jun":(0,0,0)},
    "Experiencia Impositiva Seller Dev":         {"11/mai":(67,30,104), "18/mai":(89,20,118), "25/mai":(106,19,139), "01/jun":(75,17,97), "08/jun":(105,29,145), "15/jun":(84,14,113), "22/jun":(74,19,102), "29/jun":(63,16,85)},
    "FBM-S Mature":                              {"11/mai":(12,11,25), "18/mai":(6,3,10), "25/mai":(12,2,16), "01/jun":(9,5,16), "08/jun":(13,4,19), "15/jun":(13,6,25), "22/jun":(19,9,30), "29/jun":(20,6,27)},
    "FBM-S Meli Pro":                            {"11/mai":(19,1,22), "18/mai":(21,2,26), "25/mai":(18,5,29), "01/jun":(16,3,19), "08/jun":(14,1,18), "15/jun":(24,4,28), "22/jun":(24,2,28), "29/jun":(2,2,5)},
    "FBM-S Seller Dev":                          {"11/mai":(74,27,104), "18/mai":(73,24,104), "25/mai":(60,20,90), "01/jun":(73,26,105), "08/jun":(72,30,115), "15/jun":(58,24,98), "22/jun":(78,16,102), "29/jun":(45,24,76)},
    "ME Vendedor Mature":                        {"11/mai":(53,16,72), "18/mai":(74,10,91), "25/mai":(67,14,85), "01/jun":(69,6,82), "08/jun":(62,11,82), "15/jun":(81,18,114), "22/jun":(102,14,129), "29/jun":(101,14,125)},
    "ME Vendedor Meli Pro":                      {"11/mai":(114,12,134), "18/mai":(127,12,143), "25/mai":(95,9,107), "01/jun":(93,10,105), "08/jun":(143,10,161), "15/jun":(126,13,147), "22/jun":(133,20,163), "29/jun":(57,3,64)},
    "ME Vendedor Seller Dev":                    {"11/mai":(748,64,887), "18/mai":(742,74,880), "25/mai":(759,70,911), "01/jun":(779,76,912), "08/jun":(718,73,868), "15/jun":(571,69,707), "22/jun":(608,74,743), "29/jun":(529,66,641)},
    "Otros CV":                                  {"11/mai":(223,88,329), "18/mai":(162,77,259), "25/mai":(168,78,265), "01/jun":(75,52,137), "08/jun":(70,47,124), "15/jun":(56,32,97), "22/jun":(61,24,90), "29/jun":(48,26,76)},
    "PCF Vendedor Mature":                       {"11/mai":(18,8,28), "18/mai":(34,9,44), "25/mai":(19,5,28), "01/jun":(20,7,32), "08/jun":(33,11,48), "15/jun":(17,8,28), "22/jun":(35,13,54), "29/jun":(28,11,44)},
    "PCF Vendedor Meli Pro":                     {"11/mai":(111,10,130), "18/mai":(118,18,145), "25/mai":(116,13,137), "01/jun":(85,15,106), "08/jun":(92,8,107), "15/jun":(94,20,117), "22/jun":(82,15,103), "29/jun":(40,1,44)},
    "PCF Vendedor Seller Dev":                   {"11/mai":(82,29,123), "18/mai":(75,32,116), "25/mai":(79,29,123), "01/jun":(73,18,104), "08/jun":(79,30,116), "15/jun":(90,29,132), "22/jun":(86,22,123), "29/jun":(73,29,109)},
    "PDD DS&XD - Vendedor":                      {"11/mai":(115,111,249), "18/mai":(129,100,254), "25/mai":(125,115,275), "01/jun":(145,91,257), "08/jun":(123,86,237), "15/jun":(103,93,221), "22/jun":(97,81,199), "29/jun":(100,74,188)},
    "PDD FBM - Vendedor":                        {"11/mai":(33,23,61), "18/mai":(62,25,95), "25/mai":(67,20,95), "01/jun":(57,25,86), "08/jun":(35,16,63), "15/jun":(40,22,66), "22/jun":(34,11,51), "29/jun":(23,14,47)},
    "PDD Fotos - Vendedor":                      {"11/mai":(7,3,11), "18/mai":(12,4,16), "25/mai":(8,6,17), "01/jun":(5,3,9), "08/jun":(4,0,5), "15/jun":(3,1,5), "22/jun":(0,2,2), "29/jun":(2,2,4)},
    "PDD MP,FLEX & CBT - Vendedor":              {"11/mai":(25,9,38), "18/mai":(20,10,31), "25/mai":(17,12,32), "01/jun":(18,11,34), "08/jun":(19,15,38), "15/jun":(16,13,33), "22/jun":(10,9,27), "29/jun":(13,7,24)},
    "PNR ME - Vendedor":                         {"11/mai":(22,26,59), "18/mai":(24,11,39), "25/mai":(35,16,57), "01/jun":(40,20,67), "08/jun":(25,17,44), "15/jun":(20,17,40), "22/jun":(23,8,32), "29/jun":(10,9,21)},
    "PNR MP - Vendedor":                         {"11/mai":(33,17,59), "18/mai":(26,9,44), "25/mai":(30,21,62), "01/jun":(21,12,44), "08/jun":(30,20,56), "15/jun":(34,12,51), "22/jun":(29,8,42), "29/jun":(35,17,56)},
    "Partners":                                  {"11/mai":(588,87,741), "18/mai":(520,70,660), "25/mai":(505,65,637), "01/jun":(442,65,554), "08/jun":(497,75,627), "15/jun":(664,94,840), "22/jun":(709,95,881), "29/jun":(722,91,918)},
    "Post Venta Mature":                         {"11/mai":(62,3,71), "18/mai":(50,10,66), "25/mai":(61,7,72), "01/jun":(51,1,53), "08/jun":(63,10,77), "15/jun":(59,2,64), "22/jun":(53,3,63), "29/jun":(68,6,76)},
    "Post Venta Meli Pro":                       {"11/mai":(179,8,191), "18/mai":(211,8,227), "25/mai":(178,10,193), "01/jun":(192,9,206), "08/jun":(246,11,262), "15/jun":(275,8,285), "22/jun":(251,14,266), "29/jun":(87,5,95)},
    "Post Venta Seller Dev":                     {"11/mai":(194,24,235), "18/mai":(181,19,210), "25/mai":(204,12,236), "01/jun":(181,18,218), "08/jun":(173,17,213), "15/jun":(196,16,227), "22/jun":(180,15,217), "29/jun":(144,19,180)},
    "Publicaciones Mature":                      {"11/mai":(27,5,32), "18/mai":(21,3,29), "25/mai":(19,5,24), "01/jun":(27,4,32), "08/jun":(25,3,31), "15/jun":(19,3,25), "22/jun":(27,4,38), "29/jun":(33,3,38)},
    "Publicaciones Meli Pro":                    {"11/mai":(89,3,92), "18/mai":(88,1,90), "25/mai":(87,4,95), "01/jun":(68,3,80), "08/jun":(50,1,51), "15/jun":(42,4,51), "22/jun":(65,1,67), "29/jun":(21,2,24)},
    "Publicaciones Seller Dev":                  {"11/mai":(371,81,493), "18/mai":(378,96,510), "25/mai":(476,104,649), "01/jun":(416,78,554), "08/jun":(448,96,589), "15/jun":(416,66,526), "22/jun":(402,63,519), "29/jun":(356,67,465)},
}
