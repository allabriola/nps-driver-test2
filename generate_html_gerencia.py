...
weekly_driver = {
    ...
    "PDD DS&XD - Vendedor":                      {"S2":(107,101,233), "S1":(97,81,199)},
    ...
    "PNR MP - Vendedor":                         {"S2":(34,12,51), "S1":(29,8,42)},
    "Partners":                                  {"S2":(664,94,840), "S1":(709,95,881)},
    ...
    "Publicaciones Seller Dev":                  {"S2":(417,66,527), "S1":(402,63,519)},
}

monthly_driver = {
    "CBT":                                       {"M2":(359,64,431), "M1":(328,39,378)},
    "Experiencia Impositiva Mature":             {"M2":(11,4,16), "M1":(13,7,21)},
    "Experiencia Impositiva Meli Pro":           {"M2":(13,6,22), "M1":(21,8,29)},
    "Experiencia Impositiva Seller Dev":         {"M2":(344,111,494), "M1":(338,79,457)},
    "FBM-S Mature":                              {"M2":(39,20,71), "M1":(54,24,90)},
    "FBM-S Meli Pro":                            {"M2":(67,14,93), "M1":(78,10,93)},
    "FBM-S Seller Dev":                          {"M2":(291,101,423), "M1":(281,96,420)},
    "ME Vendedor Mature":                        {"M2":(271,50,340), "M1":(314,49,407)},
    "ME Vendedor Meli Pro":                      {"M2":(476,44,541), "M1":(495,53,576)},
    "ME Vendedor Seller Dev":                    {"M2":(3112,329,3763), "M1":(2676,292,3230)},
    "Otros CV":                                  {"M2":(741,299,1118), "M1":(263,156,450)},
    "PCF Vendedor Mature":                       {"M2":(101,31,143), "M1":(105,39,162)},
    "PCF Vendedor Meli Pro":                     {"M2":(458,61,569), "M1":(353,58,433)},
    "PCF Vendedor Seller Dev":                   {"M2":(340,119,516), "M1":(328,99,475)},
    "PDD DS&XD - Vendedor":                      {"M2":(539,477,1147), "M1":(472,359,926)},
    "PDD FBM - Vendedor":                        {"M2":(212,102,341), "M1":(166,74,266)},
    "PDD Fotos - Vendedor":                      {"M2":(42,22,73), "M1":(12,6,21)},
    "PDD MP,FLEX & CBT - Vendedor":              {"M2":(92,47,149), "M1":(64,48,133)},
    "PNR ME - Vendedor":                         {"M2":(116,80,222), "M1":(108,62,184)},
    "PNR MP - Vendedor":                         {"M2":(138,73,250), "M1":(114,52,193)},
    "Partners":                                  {"M2":(2315,322,2919), "M1":(2312,329,2902)},
    "Post Venta Mature":                         {"M2":(216,28,265), "M1":(226,16,257)},
    "Post Venta Meli Pro":                       {"M2":(769,35,825), "M1":(964,42,1019)},
    "Post Venta Seller Dev":                     {"M2":(822,76,964), "M1":(730,65,874)},
    "Publicaciones Mature":                      {"M2":(90,17,116), "M1":(98,14,126)},
    "Publicaciones Meli Pro":                    {"M2":(360,13,381), "M1":(225,9,249)},
    "Publicaciones Seller Dev":                  {"M2":(1741,406,2357), "M1":(1683,303,2189)},
}
...
monthly_history = {
    "CBT":                                       {"Jan":(481,57,549), "Fev":(224,27,254), "Mar":(323,58,395), "Abr":(345,54,405), "Mai":(359,64,431), "Jun":(328,39,378)},
    ...
    "Experiencia Impositiva Seller Dev":         {"Jan":(574,111,744), "Fev":(350,86,477), "Mar":(312,108,469), "Abr":(404,113,572), "Mai":(344,111,494), "Jun":(338,79,457)},
    "FBM-S Mature":                              {"Jan":(197,94,320), "Fev":(135,61,216), "Mar":(130,45,203), "Abr":(100,28,140), "Mai":(39,20,71), "Jun":(54,24,90)},
    "FBM-S Meli Pro":                            {"Jan":(33,5,42), "Fev":(20,6,27), "Mar":(11,8,22), "Abr":(53,9,70), "Mai":(67,14,93), "Jun":(78,10,93)},
    "FBM-S Seller Dev":                          {"Jan":(537,168,793), "Fev":(340,109,501), "Mar":(347,125,524), "Abr":(344,114,500), "Mai":(291,101,423), "Jun":(281,96,420)},
    "ME Vendedor Mature":                        {"Jan":(2084,422,2688), "Fev":(779,171,1041), "Mar":(809,157,1092), "Abr":(504,103,652), "Mai":(271,50,340), "Jun":(314,49,407)},
    "ME Vendedor Meli Pro":                      {"Jan":(126,17,149), "Fev":(93,9,109), "Mar":(60,10,75), "Abr":(320,26,361), "Mai":(476,44,541), "Jun":(495,53,576)},
    "ME Vendedor Seller Dev":                    {"Jan":(8138,1110,9984), "Fev":(2568,367,3195), "Mar":(2479,377,3133), "Abr":(2710,375,3392), "Mai":(3112,329,3763), "Jun":(2676,292,3230)},
    "Otros CV":                                  {"Jan":(935,420,1472), "Fev":(844,241,1206), "Mar":(775,182,1047), "Abr":(754,244,1068), "Mai":(741,299,1118), "Jun":(263,156,450)},
    "PCF Vendedor Mature":                       {"Jan":(306,122,482), "Fev":(324,90,464), "Mar":(332,85,467), "Abr":(225,68,326), "Mai":(101,31,143), "Jun":(105,39,162)},
    "PCF Vendedor Meli Pro":                     {"Jan":(57,8,75), "Fev":(57,11,73), "Mar":(32,8,44), "Abr":(272,42,351), "Mai":(458,61,569), "Jun":(353,58,433)},
    "PCF Vendedor Seller Dev":                   {"Jan":(697,244,1059), "Fev":(529,173,768), "Mar":(536,166,790), "Abr":(395,118,569), "Mai":(340,119,516), "Jun":(328,99,475)},
    "PDD DS&XD - Vendedor":                      {"Jan":(406,324,830), "Fev":(452,332,906), "Mar":(645,486,1280), "Abr":(533,409,1041), "Mai":(539,477,1147), "Jun":(472,359,926)},
    "PDD FBM - Vendedor":                        {"Jan":(93,39,153), "Fev":(101,40,160), "Mar":(193,89,306), "Abr":(167,90,285), "Mai":(212,102,341), "Jun":(166,74,266)},
    "PDD Fotos - Vendedor":                      {"Jan":(35,18,59), "Fev":(31,18,61), "Mar":(46,22,72), "Abr":(36,23,64), "Mai":(42,22,73), "Jun":(12,6,21)},
    "PDD MP,FLEX & CBT - Vendedor":              {"Jan":(59,56,124), "Fev":(75,61,151), "Mar":(87,58,166), "Abr":(62,43,122), "Mai":(92,47,149), "Jun":(64,48,133)},
    "PNR ME - Vendedor":                         {"Jan":(83,64,169), "Fev":(86,79,186), "Mar":(103,71,193), "Abr":(150,90,258), "Mai":(116,80,222), "Jun":(108,62,184)},
    "PNR MP - Vendedor":                         {"Jan":(122,85,239), "Fev":(147,88,258), "Mar":(140,90,266), "Abr":(156,71,251), "Mai":(138,73,250), "Jun":(114,52,193)},
    "Partners":                                  {"Jan":(1793,251,2254), "Fev":(1808,217,2198), "Mar":(2228,337,2806), "Abr":(2229,360,2847), "Mai":(2315,322,2919), "Jun":(2312,329,2902)},
    "Post Venta Mature":                         {"Jan":(403,114,543), "Fev":(363,85,493), "Mar":(392,76,520), "Abr":(298,53,389), "Mai":(216,28,265), "Jun":(226,16,257)},
    "Post Venta Meli Pro":                       {"Jan":(115,11,128), "Fev":(88,9,101), "Mar":(70,10,81), "Abr":(416,15,447), "Mai":(769,35,825), "Jun":(964,42,1019)},
    "Post Venta Seller Dev":                     {"Jan":(1206,265,1585), "Fev":(983,209,1291), "Mar":(929,178,1186), "Abr":(857,116,1059), "Mai":(822,76,964), "Jun":(730,65,874)},
    "Publicaciones Mature":                      {"Jan":(321,73,429), "Fev":(286,47,362), "Mar":(258,51,345), "Abr":(185,36,256), "Mai":(90,17,116), "Jun":(98,14,126)},
    "Publicaciones Meli Pro":                    {"Jan":(43,8,53), "Fev":(34,2,40), "Mar":(18,7,26), "Abr":(185,15,208), "Mai":(360,13,381), "Jun":(225,9,249)},
    "Publicaciones Seller Dev":                  {"Jan":(3396,475,4216), "Fev":(2581,381,3231), "Mar":(2639,374,3309), "Abr":(2000,374,2600), "Mai":(1741,406,2357), "Jun":(1683,303,2189)},
}
