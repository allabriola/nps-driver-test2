...
monthly_driver = {
    "CBT":                                       {"M2":(357,43,412), "M1":(30,2,34)},
    "Experiencia Impositiva Mature":             {"M2":(13,7,21), "M1":(2,0,3)},
    "Experiencia Impositiva Meli Pro":           {"M2":(21,8,29), "M1":(0,0,0)},
    "Experiencia Impositiva Seller Dev":         {"M2":(346,87,474), "M1":(27,7,36)},
    "FBM-S Mature":                              {"M2":(58,25,95), "M1":(7,3,11)},
    "FBM-S Meli Pro":                            {"M2":(80,12,98), "M1":(0,0,0)},
    "FBM-S Seller Dev":                          {"M2":(292,104,439), "M1":(15,10,30)},
    "ME Vendedor Mature":                        {"M2":(339,53,438), "M1":(38,5,48)},
    "ME Vendedor Meli Pro":                      {"M2":(543,56,631), "M1":(9,0,9)},
    "ME Vendedor Seller Dev":                    {"M2":(2907,318,3504), "M1":(149,20,179)},
    "Otros CV":                                  {"M2":(281,167,480), "M1":(12,4,17)},
    "PCF Vendedor Mature":                       {"M2":(110,41,171), "M1":(11,5,18)},
    "PCF Vendedor Meli Pro":                     {"M2":(385,59,469), "M1":(8,0,8)},
    "PCF Vendedor Seller Dev":                   {"M2":(347,111,508), "M1":(28,14,43)},
    "PDD DS&XD - Vendedor":                      {"M2":(502,382,983), "M1":(27,16,47)},
    "PDD FBM - Vendedor":                        {"M2":(170,82,278), "M1":(3,4,9)},
    "PDD Fotos - Vendedor":                      {"M2":(13,6,22), "M1":(1,1,2)},
    "PDD MP,FLEX & CBT - Vendedor":              {"M2":(67,49,138), "M1":(4,3,8)},
    "PNR ME - Vendedor":                         {"M2":(112,64,190), "M1":(1,2,3)},
    "PNR MP - Vendedor":                         {"M2":(132,62,223), "M1":(7,2,9)},
    "Partners":                                  {"M2":(2527,355,3174), "M1":(211,34,280)},
    "Post Venta Mature":                         {"M2":(240,17,272), "M1":(25,1,27)},
    "Post Venta Meli Pro":                       {"M2":(1038,46,1099), "M1":(13,1,15)},
    "Post Venta Seller Dev":                     {"M2":(784,71,941), "M1":(38,8,49)},
    "Publicaciones Mature":                      {"M2":(106,14,134), "M1":(16,3,19)},
    "Publicaciones Meli Pro":                    {"M2":(245,11,272), "M1":(1,0,1)},
    "Publicaciones Seller Dev":                  {"M2":(1793,329,2338), "M1":(123,20,154)},
}

drivers_vigente = {
    "CBT":                                       (55,6,64),
    "Experiencia Impositiva Mature":             (2,0,3),
    "Experiencia Impositiva Meli Pro":           (0,0,0),
    "Experiencia Impositiva Seller Dev":         (35,15,53),
    "FBM-S Mature":                              (11,4,16),
    "FBM-S Meli Pro":                            (2,2,5),
    "FBM-S Seller Dev":                          (26,18,49),
    "ME Vendedor Mature":                        (63,9,79),
    "ME Vendedor Meli Pro":                      (57,3,64),
    "ME Vendedor Seller Dev":                    (380,46,453),
    "Otros CV":                                  (30,15,47),
    "PCF Vendedor Mature":                       (16,7,27),
    "PCF Vendedor Meli Pro":                     (40,1,44),
    "PCF Vendedor Seller Dev":                   (47,26,76),
    "PDD DS&XD - Vendedor":                      (57,36,101),
    "PDD FBM - Vendedor":                        (7,12,21),
    "PDD Fotos - Vendedor":                      (2,1,3),
    "PDD MP,FLEX & CBT - Vendedor":              (7,4,13),
    "PNR ME - Vendedor":                         (5,4,9),
    "PNR MP - Vendedor":                         (24,11,37),
    "Partners":                                  (426,60,551),
    "Post Venta Mature":                         (39,2,42),
    "Post Venta Meli Pro":                       (87,5,95),
    "Post Venta Seller Dev":                     (92,14,116),
    "Publicaciones Mature":                      (24,3,27),
    "Publicaciones Meli Pro":                    (21,2,24),
    "Publicaciones Seller Dev":                  (232,46,301),
}

# ═══════════════════════════════════════════════════════════════
# SECTION 2C: HISTORICAL DATA
# ═══════════════════════════════════════════════════════════════
MONTH_LABELS = ["Fev", "Mar", "Abr", "Mai", "Jun", "Jul"]
WEEK_LABELS  = ["04/mai", "11/mai", "18/mai", "25/mai", "01/jun", "08/jun", "15/jun", "22/jun"]

monthly_history = {
    "CBT":                                       {"Fev":(224,27,254), "Mar":(323,58,395), "Abr":(345,54,405), "Mai":(359,64,431), "Jun":(357,43,412), "Jul":(30,2,34)},
    "Experiencia Impositiva Mature":             {"Fev":(49,14,70), "Mar":(45,20,72), "Abr":(28,7,40), "Mai":(11,4,16), "Jun":(13,7,21), "Jul":(2,0,3)},
    "Experiencia Impositiva Meli Pro":           {"Fev":(1,3,5), "Mar":(8,4,13), "Abr":(13,3,18), "Mai":(13,6,22), "Jun":(21,8,29), "Jul":(0,0,0)},
    "Experiencia Impositiva Seller Dev":         {"Fev":(350,86,477), "Mar":(312,108,469), "Abr":(404,113,572), "Mai":(344,111,494), "Jun":(346,87,474), "Jul":(27,7,36)},
    "FBM-S Mature":                              {"Fev":(135,61,216), "Mar":(130,45,203), "Abr":(100,28,140), "Mai":(39,20,71), "Jun":(58,25,95), "Jul":(7,3,11)},
    "FBM-S Meli Pro":                            {"Fev":(20,6,27), "Mar":(11,8,22), "Abr":(53,9,70), "Mai":(67,14,93), "Jun":(80,12,98), "Jul":(0,0,0)},
    "FBM-S Seller Dev":                          {"Fev":(340,109,501), "Mar":(347,125,524), "Abr":(344,114,500), "Mai":(291,101,423), "Jun":(292,104,439), "Jul":(15,10,30)},
    "ME Vendedor Mature":                        {"Fev":(779,171,1041), "Mar":(809,157,1092), "Abr":(504,103,652), "Mai":(271,50,340), "Jun":(339,53,438), "Jul":(38,5,48)},
    "ME Vendedor Meli Pro":                      {"Fev":(93,9,109), "Mar":(60,10,75), "Abr":(320,26,361), "Mai":(476,44,541), "Jun":(543,56,631), "Jul":(9,0,9)},
    "ME Vendedor Seller Dev":                    {"Fev":(2568,367,3195), "Mar":(2479,377,3133), "Abr":(2710,375,3392), "Mai":(3112,329,3763), "Jun":(2907,318,3504), "Jul":(149,20,179)},
    "Otros CV":                                  {"Fev":(844,241,1206), "Mar":(775,182,1047), "Abr":(754,244,1068), "Mai":(741,299,1118), "Jun":(281,167,480), "Jul":(12,4,17)},
    "PCF Vendedor Mature":                       {"Fev":(324,90,464), "Mar":(332,85,467), "Abr":(225,68,326), "Mai":(101,31,143), "Jun":(110,41,171), "Jul":(11,5,18)},
    "PCF Vendedor Meli Pro":                     {"Fev":(57,11,73), "Mar":(32,8,44), "Abr":(272,42,351), "Mai":(458,61,569), "Jun":(385,59,469), "Jul":(8,0,8)},
    "PCF Vendedor Seller Dev":                   {"Fev":(529,173,768), "Mar":(536,166,790), "Abr":(395,118,569), "Mai":(340,119,516), "Jun":(347,111,508), "Jul":(28,14,43)},
    "PDD DS&XD - Vendedor":                      {"Fev":(452,332,906), "Mar":(645,486,1280), "Abr":(533,409,1041), "Mai":(539,477,1147), "Jun":(502,382,983), "Jul":(27,16,47)},
    "PDD FBM - Vendedor":                        {"Fev":(101,40,160), "Mar":(193,89,306), "Abr":(167,90,285), "Mai":(212,102,341), "Jun":(170,82,278), "Jul":(3,4,9)},
    "PDD Fotos - Vendedor":                      {"Fev":(31,18,61), "Mar":(46,22,72), "Abr":(36,23,64), "Mai":(42,22,73), "Jun":(13,6,22), "Jul":(1,1,2)},
    "PDD MP,FLEX & CBT - Vendedor":              {"Fev":(75,61,151), "Mar":(87,58,166), "Abr":(62,43,122), "Mai":(92,47,149), "Jun":(67,49,138), "Jul":(4,3,8)},
    "PNR ME - Vendedor":                         {"Fev":(86,79,186), "Mar":(103,71,193), "Abr":(150,90,258), "Mai":(116,80,222), "Jun":(112,64,190), "Jul":(1,2,3)},
    "PNR MP - Vendedor":                         {"Fev":(147,88,258), "Mar":(140,90,266), "Abr":(156,71,251), "Mai":(138,73,250), "Jun":(132,62,223), "Jul":(7,2,9)},
    "Partners":                                  {"Fev":(1808,217,2198), "Mar":(2228,337,2806), "Abr":(2229,360,2847), "Mai":(2315,322,2919), "Jun":(2527,355,3174), "Jul":(211,34,280)},
    "Post Venta Mature":                         {"Fev":(363,85,493), "Mar":(392,76,520), "Abr":(298,53,389), "Mai":(216,28,265), "Jun":(240,17,272), "Jul":(25,1,27)},
    "Post Venta Meli Pro":                       {"Fev":(88,9,101), "Mar":(70,10,81), "Abr":(416,15,447), "Mai":(769,35,825), "Jun":(1038,46,1099), "Jul":(13,1,15)},
    "Post Venta Seller Dev":                     {"Fev":(983,209,1291), "Mar":(929,178,1186), "Abr":(857,116,1059), "Mai":(822,76,964), "Jun":(784,71,941), "Jul":(38,8,49)},
    "Publicaciones Mature":                      {"Fev":(286,47,362), "Mar":(258,51,345), "Abr":(185,36,256), "Mai":(90,17,116), "Jun":(106,14,134), "Jul":(16,3,19)},
    "Publicaciones Meli Pro":                    {"Fev":(34,2,40), "Mar":(18,7,26), "Abr":(185,15,208), "Mai":(360,13,381), "Jun":(245,11,272), "Jul":(1,0,1)},
    "Publicaciones Seller Dev":                  {"Fev":(2581,381,3231), "Mar":(2639,374,3309), "Abr":(2000,374,2600), "Mai":(1741,406,2357), "Jun":(1793,329,2338), "Jul":(123,20,154)},
}
