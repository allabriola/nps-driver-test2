...
monthly_driver = {
    "CBT":                                       {"M2":(359,64,431), "M1":(355,42,409)},
    "Experiencia Impositiva Mature":             {"M2":(11,4,16), "M1":(13,7,21)},
    "Experiencia Impositiva Meli Pro":           {"M2":(13,6,22), "M1":(21,8,29)},
    "Experiencia Impositiva Seller Dev":         {"M2":(344,111,494), "M1":(346,87,474)},
    "FBM-S Mature":                              {"M2":(39,20,71), "M1":(58,25,95)},
    "FBM-S Meli Pro":                            {"M2":(67,14,93), "M1":(80,12,98)},
    "FBM-S Seller Dev":                          {"M2":(291,101,423), "M1":(292,104,439)},
    "ME Vendedor Mature":                        {"M2":(271,50,340), "M1":(338,53,437)},
    "ME Vendedor Meli Pro":                      {"M2":(476,44,541), "M1":(543,56,631)},
    "ME Vendedor Seller Dev":                    {"M2":(3112,329,3763), "M1":(2900,318,3497)},
    "Otros CV":                                  {"M2":(741,299,1118), "M1":(281,166,479)},
    "PCF Vendedor Mature":                       {"M2":(101,31,143), "M1":(110,41,171)},
    "PCF Vendedor Meli Pro":                     {"M2":(458,61,569), "M1":(385,59,469)},
    "PCF Vendedor Seller Dev":                   {"M2":(340,119,516), "M1":(347,110,507)},
    "PDD DS&XD - Vendedor":                      {"M2":(539,477,1147), "M1":(496,378,971)},
    "PDD FBM - Vendedor":                        {"M2":(212,102,341), "M1":(170,81,277)},
    "PDD Fotos - Vendedor":                      {"M2":(42,22,73), "M1":(13,6,22)},
    "PDD MP,FLEX & CBT - Vendedor":              {"M2":(92,47,149), "M1":(67,49,137)},
    "PNR ME - Vendedor":                         {"M2":(116,80,222), "M1":(111,63,188)},
    "PNR MP - Vendedor":                         {"M2":(138,73,250), "M1":(130,61,219)},
    "Partners":                                  {"M2":(2315,322,2919), "M1":(2510,353,3153)},
    "Post Venta Mature":                         {"M2":(216,28,265), "M1":(239,17,271)},
    "Post Venta Meli Pro":                       {"M2":(769,35,825), "M1":(1038,46,1099)},
    "Post Venta Seller Dev":                     {"M2":(822,76,964), "M1":(782,70,936)},
    "Publicaciones Mature":                      {"M2":(90,17,116), "M1":(106,14,134)},
    "Publicaciones Meli Pro":                    {"M2":(360,13,381), "M1":(245,11,272)},
    "Publicaciones Seller Dev":                  {"M2":(1741,406,2357), "M1":(1785,326,2325)},
}
...
# ═══════════════════════════════════════════════════════════════
MONTH_LABELS = ["Fev", "Mar", "Abr", "Mai", "Jun"]
WEEK_LABELS  = ["04/mai", "11/mai", "18/mai", "25/mai", "01/jun", "08/jun", "15/jun", "22/jun"]

monthly_history = {
    "CBT":                                       {"Fev":(224,27,254), "Mar":(323,58,395), "Abr":(345,54,405), "Mai":(359,64,431), "Jun":(355,42,409)},
    "Experiencia Impositiva Mature":             {"Fev":(49,14,70), "Mar":(45,20,72), "Abr":(28,7,40), "Mai":(11,4,16), "Jun":(13,7,21)},
    "Experiencia Impositiva Meli Pro":           {"Fev":(1,3,5), "Mar":(8,4,13), "Abr":(13,3,18), "Mai":(13,6,22), "Jun":(21,8,29)},
    "Experiencia Impositiva Seller Dev":         {"Fev":(350,86,477), "Mar":(312,108,469), "Abr":(404,113,572), "Mai":(344,111,494), "Jun":(346,87,474)},
    "FBM-S Mature":                              {"Fev":(135,61,216), "Mar":(130,45,203), "Abr":(100,28,140), "Mai":(39,20,71), "Jun":(58,25,95)},
    "FBM-S Meli Pro":                            {"Fev":(20,6,27), "Mar":(11,8,22), "Abr":(53,9,70), "Mai":(67,14,93), "Jun":(80,12,98)},
    "FBM-S Seller Dev":                          {"Fev":(340,109,501), "Mar":(347,125,524), "Abr":(344,114,500), "Mai":(291,101,423), "Jun":(292,104,439)},
    "ME Vendedor Mature":                        {"Fev":(779,171,1041), "Mar":(809,157,1092), "Abr":(504,103,652), "Mai":(271,50,340), "Jun":(338,53,437)},
    "ME Vendedor Meli Pro":                      {"Fev":(93,9,109), "Mar":(60,10,75), "Abr":(320,26,361), "Mai":(476,44,541), "Jun":(543,56,631)},
    "ME Vendedor Seller Dev":                    {"Fev":(2568,367,3195), "Mar":(2479,377,3133), "Abr":(2710,375,3392), "Mai":(3112,329,3763), "Jun":(2900,318,3497)},
    "Otros CV":                                  {"Fev":(844,241,1206), "Mar":(775,182,1047), "Abr":(754,244,1068), "Mai":(741,299,1118), "Jun":(281,166,479)},
    "PCF Vendedor Mature":                       {"Fev":(324,90,464), "Mar":(332,85,467), "Abr":(225,68,326), "Mai":(101,31,143), "Jun":(110,41,171)},
    "PCF Vendedor Meli Pro":                     {"Fev":(57,11,73), "Mar":(32,8,44), "Abr":(272,42,351), "Mai":(458,61,569), "Jun":(385,59,469)},
    "PCF Vendedor Seller Dev":                   {"Fev":(529,173,768), "Mar":(536,166,790), "Abr":(395,118,569), "Mai":(340,119,516), "Jun":(347,110,507)},
    "PDD DS&XD - Vendedor":                      {"Fev":(452,332,906), "Mar":(645,486,1280), "Abr":(533,409,1041), "Mai":(539,477,1147), "Jun":(496,378,971)},
    "PDD FBM - Vendedor":                        {"Fev":(101,40,160), "Mar":(193,89,306), "Abr":(167,90,285), "Mai":(212,102,341), "Jun":(170,81,277)},
    "PDD Fotos - Vendedor":                      {"Fev":(31,18,61), "Mar":(46,22,72), "Abr":(36,23,64), "Mai":(42,22,73), "Jun":(13,6,22)},
    "PDD MP,FLEX & CBT - Vendedor":              {"Fev":(75,61,151), "Mar":(87,58,166), "Abr":(62,43,122), "Mai":(92,47,149), "Jun":(67,49,137)},
    "PNR ME - Vendedor":                         {"Fev":(86,79,186), "Mar":(103,71,193), "Abr":(150,90,258), "Mai":(116,80,222), "Jun":(111,63,188)},
    "PNR MP - Vendedor":                         {"Fev":(147,88,258), "Mar":(140,90,266), "Abr":(156,71,251), "Mai":(138,73,250), "Jun":(130,61,219)},
    "Partners":                                  {"Fev":(1808,217,2198), "Mar":(2228,337,2806), "Abr":(2229,360,2847), "Mai":(2315,322,2919), "Jun":(2510,353,3153)},
    "Post Venta Mature":                         {"Fev":(363,85,493), "Mar":(392,76,520), "Abr":(298,53,389), "Mai":(216,28,265), "Jun":(239,17,271)},
    "Post Venta Meli Pro":                       {"Fev":(88,9,101), "Mar":(70,10,81), "Abr":(416,15,447), "Mai":(769,35,825), "Jun":(1038,46,1099)},
    "Post Venta Seller Dev":                     {"Fev":(983,209,1291), "Mar":(929,178,1186), "Abr":(857,116,1059), "Mai":(822,76,964), "Jun":(782,70,936)},
    "Publicaciones Mature":                      {"Fev":(286,47,362), "Mar":(258,51,345), "Abr":(185,36,256), "Mai":(90,17,116), "Jun":(106,14,134)},
    "Publicaciones Meli Pro":                    {"Fev":(34,2,40), "Mar":(18,7,26), "Abr":(185,15,208), "Mai":(360,13,381), "Jun":(245,11,272)},
    "Publicaciones Seller Dev":                  {"Fev":(2581,381,3231), "Mar":(2639,374,3309), "Abr":(2000,374,2600), "Mai":(1741,406,2357), "Jun":(1785,326,2325)},
}
