...
S1_LABEL  = "22/jun – 28/jun"
S2_LABEL  = "15/jun – 21/jun"
VIG_LABEL = "29/jun – 29/jun"
M1_LABEL  = "Junho 2026"
M2_LABEL  = "Maio 2026"
...
# ═══════════════════════════════════════════════════════════════
weekly_driver = {
    "CBT":                                       {"S2":(73,8,82), "S1":(84,7,94)},
    "Experiencia Impositiva Mature":             {"S2":(4,1,5), "S1":(2,4,7)},
    "Experiencia Impositiva Meli Pro":           {"S2":(6,2,8), "S1":(5,0,5)},
    "Experiencia Impositiva Seller Dev":         {"S2":(84,14,113), "S1":(74,19,102)},
    "FBM-S Mature":                              {"S2":(13,6,25), "S1":(19,9,30)},
    "FBM-S Meli Pro":                            {"S2":(24,4,28), "S1":(24,2,28)},
    "FBM-S Seller Dev":                          {"S2":(58,24,98), "S1":(78,16,102)},
    "ME Vendedor Mature":                        {"S2":(81,18,114), "S1":(102,14,129)},
    "ME Vendedor Meli Pro":                      {"S2":(126,13,147), "S1":(133,20,163)},
    "ME Vendedor Seller Dev":                    {"S2":(571,69,707), "S1":(608,74,743)},
    "Otros CV":                                  {"S2":(57,33,99), "S1":(61,24,90)},
    "PCF Vendedor Mature":                       {"S2":(17,8,28), "S1":(35,13,54)},
    "PCF Vendedor Meli Pro":                     {"S2":(94,20,117), "S1":(82,15,103)},
    "PCF Vendedor Seller Dev":                   {"S2":(90,29,132), "S1":(86,22,123)},
    "PDD DS&XD - Vendedor":                      {"S2":(107,101,233), "S1":(97,84,202)},
    "PDD FBM - Vendedor":                        {"S2":(40,22,66), "S1":(34,11,51)},
    "PDD Fotos - Vendedor":                      {"S2":(3,1,5), "S1":(0,2,2)},
    "PDD MP,FLEX & CBT - Vendedor":              {"S2":(17,13,34), "S1":(10,9,27)},
    "PNR ME - Vendedor":                         {"S2":(20,17,41), "S1":(23,8,32)},
    "PNR MP - Vendedor":                         {"S2":(34,12,51), "S1":(30,9,44)},
    "Partners":                                  {"S2":(664,94,840), "S1":(709,95,882)},
    "Post Venta Mature":                         {"S2":(59,2,64), "S1":(53,3,63)},
    "Post Venta Meli Pro":                       {"S2":(275,8,285), "S1":(251,14,266)},
    "Post Venta Seller Dev":                     {"S2":(196,16,227), "S1":(180,15,217)},
    "Publicaciones Mature":                      {"S2":(19,3,25), "S1":(27,4,38)},
    "Publicaciones Meli Pro":                    {"S2":(42,4,51), "S1":(65,1,67)},
    "Publicaciones Seller Dev":                  {"S2":(417,66,527), "S1":(403,63,521)},
}

monthly_driver = {
    "CBT":                                       {"M2":(359,64,431), "M1":(345,40,397)},
    "Experiencia Impositiva Mature":             {"M2":(11,4,16), "M1":(13,7,21)},
    "Experiencia Impositiva Meli Pro":           {"M2":(13,6,22), "M1":(21,8,29)},
    "Experiencia Impositiva Seller Dev":         {"M2":(344,111,494), "M1":(342,82,465)},
    "FBM-S Mature":                              {"M2":(39,20,71), "M1":(55,24,91)},
    "FBM-S Meli Pro":                            {"M2":(67,14,93), "M1":(80,10,96)},
    "FBM-S Seller Dev":                          {"M2":(291,101,423), "M1":(286,98,427)},
    "ME Vendedor Mature":                        {"M2":(271,50,340), "M1":(320,50,414)},
    "ME Vendedor Meli Pro":                      {"M2":(476,44,541), "M1":(516,54,600)},
    "ME Vendedor Seller Dev":                    {"M2":(3112,329,3763), "M1":(2769,304,3343)},
    "Otros CV":                                  {"M2":(741,299,1118), "M1":(269,159,460)},
    "PCF Vendedor Mature":                       {"M2":(101,31,143), "M1":(107,41,167)},
    "PCF Vendedor Meli Pro":                     {"M2":(458,61,569), "M1":(368,58,450)},
    "PCF Vendedor Seller Dev":                   {"M2":(340,119,516), "M1":(338,100,486)},
    "PDD DS&XD - Vendedor":                      {"M2":(539,477,1147), "M1":(480,372,948)},
    "PDD FBM - Vendedor":                        {"M2":(212,102,341), "M1":(169,74,269)},
    "PDD Fotos - Vendedor":                      {"M2":(42,22,73), "M1":(12,6,21)},
    "PDD MP,FLEX & CBT - Vendedor":              {"M2":(92,47,149), "M1":(66,48,135)},
    "PNR ME - Vendedor":                         {"M2":(116,80,222), "M1":(110,62,186)},
    "PNR MP - Vendedor":                         {"M2":(138,73,250), "M1":(124,57,208)},
    "Partners":                                  {"M2":(2315,322,2919), "M1":(2394,340,3009)},
    "Post Venta Mature":                         {"M2":(216,28,265), "M1":(231,16,262)},
    "Post Venta Meli Pro":                       {"M2":(769,35,825), "M1":(989,44,1046)},
    "Post Venta Seller Dev":                     {"M2":(822,76,964), "M1":(753,69,903)},
    "Publicaciones Mature":                      {"M2":(90,17,116), "M1":(105,14,133)},
    "Publicaciones Meli Pro":                    {"M2":(360,13,381), "M1":(228,10,254)},
    "Publicaciones Seller Dev":                  {"M2":(1741,406,2357), "M1":(1726,309,2245)},
}
...
drivers_vigente = {
    ...
    "Experiencia Impositiva Seller Dev":         (8,8,17),
    "FBM-S Mature":                              (4,1,5),
    "FBM-S Meli Pro":                            (2,2,5),
    "FBM-S Seller Dev":                          (11,8,19),
    "ME Vendedor Mature":                        (24,4,30),
    "ME Vendedor Meli Pro":                      (48,3,55),
    "ME Vendedor Seller Dev":                    (224,26,267),
    "Otros CV":                                  (18,10,29),
    "PCF Vendedor Mature":                       (5,2,9),
    "PCF Vendedor Meli Pro":                     (32,1,36),
    "PCF Vendedor Seller Dev":                   (19,11,32),
    "PDD DS&XD - Vendedor":                      (24,16,42),
    "PDD FBM - Vendedor":                        (4,7,11),
    "PDD Fotos - Vendedor":                      (1,0,1),
    "PDD MP,FLEX & CBT - Vendedor":              (3,1,4),
    "PNR ME - Vendedor":                         (3,1,4),
    "PNR MP - Vendedor":                         (15,8,24),
    "Partners":                                  (198,24,250),
    "Post Venta Mature":                         (13,1,14),
    "Post Venta Meli Pro":                       (74,4,80),
    "Post Venta Seller Dev":                     (52,5,62),
    "Publicaciones Mature":                      (8,0,8),
    "Publicaciones Meli Pro":                    (20,2,23),
    "Publicaciones Seller Dev":                  (101,23,134),
}
...
WEEK_LABELS  = ["04/mai", "11/mai", "18/mai", "25/mai", "01/jun", "08/jun", "15/jun", "22/jun"]

monthly_history = {
    "CBT":                                       {"Jan":(481,57,549), "Fev":(224,27,254), "Mar":(323,58,395), "Abr":(345,54,405), "Mai":(359,64,431), "Jun":(345,40,397)},
    "Experiencia Impositiva Mature":             {"Jan":(81,18,113), "Fev":(49,14,70), "Mar":(45,20,72), "Abr":(28,7,40), "Mai":(11,4,16), "Jun":(13,7,21)},
    "Experiencia Impositiva Meli Pro":           {"Jan":(8,6,16), "Fev":(1,3,5), "Mar":(8,4,13), "Abr":(13,3,18), "Mai":(13,6,22), "Jun":(21,8,29)},
    "Experiencia Impositiva Seller Dev":         {"Jan":(574,111,744), "Fev":(350,86,477), "Mar":(312,108,469), "Abr":(404,113,572), "Mai":(344,111,494), "Jun":(342,82,465)},
    "FBM-S Mature":                              {"Jan":(197,94,320), "Fev":(135,61,216), "Mar":(130,45,203), "Abr":(100,28,140), "Mai":(39,20,71), "Jun":(55,24,91)},
    "FBM-S Meli Pro":                            {"Jan":(33,5,42), "Fev":(20,6,27), "Mar":(11,8,22), "Abr":(53,9,70), "Mai":(67,14,93), "Jun":(80,10,96)},
    "FBM-S Seller Dev":                          {"Jan":(537,168,793), "Fev":(340,109,501), "Mar":(347,125,524), "Abr":(344,114,500), "Mai":(291,101,423), "Jun":(286,98,427)},
    "ME Vendedor Mature":                        {"Jan":(2084,422,2688), "Fev":(779,171,1041), "Mar":(809,157,1092), "Abr":(504,103,652), "Mai":(271,50,340), "Jun":(320,50,414)},
    "ME Vendedor Meli Pro":                      {"Jan":(126,17,149), "Fev":(93,9,109), "Mar":(60,10,75), "Abr":(320,26,361), "Mai":(476,44,541), "Jun":(516,54,600)},
    "ME Vendedor Seller Dev":                    {"Jan":(8138,1110,9984), "Fev":(2568,367,3195), "Mar":(2479,377,3133), "Abr":(2710,375,3392), "Mai":(3112,329,3763), "Jun":(2769,304,3343)},
    "Otros CV":                                  {"Jan":(935,420,1472), "Fev":(844,241,1206), "Mar":(775,182,1047), "Abr":(754,244,1068), "Mai":(741,299,1118), "Jun":(269,159,460)},
    "PCF Vendedor Mature":                       {"Jan":(306,122,482), "Fev":(324,90,464), "Mar":(332,85,467), "Abr":(225,68,326), "Mai":(101,31,143), "Jun":(107,41,167)},
    "PCF Vendedor Meli Pro":                     {"Jan":(57,8,75), "Fev":(57,11,73), "Mar":(32,8,44), "Abr":(272,42,351), "Mai":(458,61,569), "Jun":(368,58,450)},
    "PCF Vendedor Seller Dev":                   {"Jan":(697,244,1059), "Fev":(529,173,768), "Mar":(536,166,790), "Abr":(395,118,569), "Mai":(340,119,516), "Jun":(338,100,486)},
    "PDD DS&XD - Vendedor":                      {"Jan":(406,324,830), "Fev":(452,332,906), "Mar":(645,486,1280), "Abr":(533,409,1041), "Mai":(539,477,1147), "Jun":(480,372,948)},
    "PDD FBM - Vendedor":                        {"Jan":(93,39,153), "Fev":(101,40,160), "Mar":(193,89,306), "Abr":(167,90,285), "Mai":(212,102,341), "Jun":(169,74,269)},
    "PDD Fotos - Vendedor":                      {"Jan":(35,18,59), "Fev":(31,18,61), "Mar":(46,22,72), "Abr":(36,23,64), "Mai":(42,22,73), "Jun":(12,6,21)},
    "PDD MP,FLEX & CBT - Vendedor":              {"Jan":(59,56,124), "Fev":(75,61,151), "Mar":(87,58,166), "Abr":(62,43,122), "Mai":(92,47,149), "Jun":(66,48,135)},
    "PNR ME - Vendedor":                         {"Jan":(83,64,169), "Fev":(86,79,186), "Mar":(103,71,193), "Abr":(150,90,258), "Mai":(116,80,222), "Jun":(110,62,186)},
    "PNR MP - Vendedor":                         {"Jan":(122,85,239), "Fev":(147,88,258), "Mar":(140,90,266), "Abr":(156,71,251), "Mai":(138,73,250), "Jun":(124,57,208)},
    "Partners":                                  {"Jan":(1793,251,2254), "Fev":(1808,217,2198), "Mar":(2228,337,2806), "Abr":(2229,360,2847), "Mai":(2315,322,2919), "Jun":(2394,340,3009)},
    "Post Venta Mature":                         {"Jan":(403,114,543), "Fev":(363,85,493), "Mar":(392,76,520), "Abr":(298,53,389), "Mai":(216,28,265), "Jun":(231,16,262)},
    "Post Venta Meli Pro":                       {"Jan":(115,11,128), "Fev":(88,9,101), "Mar":(70,10,81), "Abr":(416,15,447), "Mai":(769,35,825), "Jun":(989,44,1046)},
    "Post Venta Seller Dev":                     {"Jan":(1206,265,1585), "Fev":(983,209,1291), "Mar":(929,178,1186), "Abr":(857,116,1059), "Mai":(822,76,964), "Jun":(753,69,903)},
    "Publicaciones Mature":                      {"Jan":(321,73,429), "Fev":(286,47,362), "Mar":(258,51,345), "Abr":(185,36,256), "Mai":(90,17,116), "Jun":(105,14,133)},
    "Publicaciones Meli Pro":                    {"Jan":(43,8,53), "Fev":(34,2,40), "Mar":(18,7,26), "Abr":(185,15,208), "Mai":(360,13,381), "Jun":(228,10,254)},
    "Publicaciones Seller Dev":                  {"Jan":(3396,475,4216), "Fev":(2581,381,3231), "Mar":(2639,374,3309), "Abr":(2000,374,2600), "Mai":(1741,406,2357), "Jun":(1726,309,2245)},
}

weekly_history = {
    "CBT":                                       {"04/mai":(85,12,100), "11/mai":(59,14,75), "18/mai":(98,23,122), "25/mai":(98,12,111), "01/jun":(75,12,90), "08/jun":(100,12,116), "15/jun":(73,8,82), "22/jun":(80,7,90)},
    "Experiencia Impositiva Mature":             {"04/mai":(5,0,5), "11/mai":(4,1,5), "18/mai":(2,1,3), "25/mai":(0,2,3), "01/jun":(4,2,6), "08/jun":(3,0,3), "15/jun":(4,1,5), "22/jun":(2,4,7)},
    "Experiencia Impositiva Meli Pro":           {"04/mai":(2,1,3), "11/mai":(4,0,5), "18/mai":(7,2,10), "25/mai":(0,3,4), "01/jun":(5,4,9), "08/jun":(5,2,7), "15/jun":(6,2,8), "22/jun":(5,0,5)},
    "Experiencia Impositiva Seller Dev":         {"04/mai":(72,36,116), "11/mai":(67,30,104), "18/mai":(89,20,118), "25/mai":(106,19,139), "01/jun":(75,17,97), "08/jun":(105,29,145), "15/jun":(84,14,113), "22/jun":(74,19,102)},
    "FBM-S Mature":                              {"04/mai":(9,4,20), "11/mai":(12,11,25), "18/mai":(6,3,10), "25/mai":(12,2,16), "01/jun":(9,5,16), "08/jun":(13,4,19), "15/jun":(13,6,25), "22/jun":(19,9,30)},
    "FBM-S Meli Pro":                            {"04/mai":(9,6,16), "11/mai":(19,1,22), "18/mai":(21,2,26), "25/mai":(18,5,29), "01/jun":(16,3,19), "08/jun":(14,1,18), "15/jun":(24,4,28), "22/jun":(24,2,28)},
    "FBM-S Seller Dev":                          {"04/mai":(69,24,104), "11/mai":(74,27,104), "18/mai":(73,24,104), "25/mai":(60,20,90), "01/jun":(73,26,105), "08/jun":(72,30,115), "15/jun":(58,24,98), "22/jun":(78,16,102)},
    "ME Vendedor Mature":                        {"04/mai":(75,10,89), "11/mai":(53,16,72), "18/mai":(74,10,91), "25/mai":(67,14,85), "01/jun":(69,6,82), "08/jun":(62,11,82), "15/jun":(81,18,114), "22/jun":(102,14,129)},
    "ME Vendedor Meli Pro":                      {"04/mai":(140,11,157), "11/mai":(114,12,134), "18/mai":(127,12,143), "25/mai":(95,9,107), "01/jun":(93,10,105), "08/jun":(143,10,161), "15/jun":(126,13,147), "22/jun":(133,20,163)},
    "ME Vendedor Seller Dev":                    {"04/mai":(739,108,940), "11/mai":(748,64,887), "18/mai":(742,74,880), "25/mai":(759,70,911), "01/jun":(779,76,912), "08/jun":(718,73,868), "15/jun":(571,69,707), "22/jun":(608,74,743)},
    "Otros CV":                                  {"04/mai":(165,47,231), "11/mai":(223,88,329), "18/mai":(162,77,259), "25/mai":(168,78,265), "01/jun":(75,52,137), "08/jun":(70,47,124), "15/jun":(56,32,97), "22/jun":(61,24,90)},
    "PCF Vendedor Mature":                       {"04/mai":(30,8,42), "11/mai":(18,8,28), "18/mai":(34,9,44), "25/mai":(19,5,28), "01/jun":(20,7,32), "08/jun":(33,11,48), "15/jun":(17,8,28), "22/jun":(35,13,54)},
    "PCF Vendedor Meli Pro":                     {"04/mai":(113,20,157), "11/mai":(111,10,130), "18/mai":(118,18,145), "25/mai":(116,13,137), "01/jun":(85,15,106), "08/jun":(92,8,107), "15/jun":(94,20,117), "22/jun":(82,15,103)},
    "PCF Vendedor Seller Dev":                   {"04/mai":(94,28,138), "11/mai":(82,29,123), "18/mai":(75,32,116), "25/mai":(79,29,123), "01/jun":(73,18,104), "08/jun":(79,30,116), "15/jun":(90,29,132), "22/jun":(86,22,123)},
    "PDD DS&XD - Vendedor":                      {"04/mai":(122,104,268), "11/mai":(115,111,249), "18/mai":(129,100,254), "25/mai":(125,115,275), "01/jun":(145,91,257), "08/jun":(123,86,237), "15/jun":(103,93,221), "22/jun":(97,81,199)},
    "PDD FBM - Vendedor":                        {"04/mai":(31,26,61), "11/mai":(33,23,61), "18/mai":(62,25,95), "25/mai":(67,20,95), "01/jun":(57,25,86), "08/jun":(35,16,63), "15/jun":(40,22,66), "22/jun":(34,11,51)},
    "PDD Fotos - Vendedor":                      {"04/mai":(14,8,24), "11/mai":(7,3,11), "18/mai":(12,4,16), "25/mai":(8,6,17), "01/jun":(5,3,9), "08/jun":(4,0,5), "15/jun":(3,1,5), "22/jun":(0,2,2)},
    "PDD MP,FLEX & CBT - Vendedor":              {"04/mai":(21,9,31), "11/mai":(25,9,38), "18/mai":(20,10,31), "25/mai":(17,12,32), "01/jun":(18,11,34), "08/jun":(19,15,38), "15/jun":(16,13,33), "22/jun":(10,9,27)},
    "PNR ME - Vendedor":                         {"04/mai":(26,18,48), "11/mai":(22,26,59), "18/mai":(24,11,39), "25/mai":(35,16,57), "01/jun":(40,20,67), "08/jun":(25,17,44), "15/jun":(20,17,40), "22/jun":(23,8,32)},
    "PNR MP - Vendedor":                         {"04/mai":(30,18,54), "11/mai":(33,17,59), "18/mai":(26,9,44), "25/mai":(30,21,62), "01/jun":(21,12,44), "08/jun":(30,20,56), "15/jun":(34,12,51), "22/jun":(29,8,42)},
    "Partners":                                  {"04/mai":(516,74,642), "11/mai":(588,87,741), "18/mai":(520,70,660), "25/mai":(505,65,637), "01/jun":(442,65,554), "08/jun":(497,75,627), "15/jun":(664,94,840), "22/jun":(709,95,881)},
    "Post Venta Mature":                         {"04/mai":(40,8,53), "11/mai":(62,3,71), "18/mai":(50,10,66), "25/mai":(61,7,72), "01/jun":(51,1,53), "08/jun":(63,10,77), "15/jun":(59,2,64), "22/jun":(53,3,63)},
    "Post Venta Meli Pro":                       {"04/mai":(200,9,213), "11/mai":(179,8,191), "18/mai":(211,8,227), "25/mai":(178,10,193), "01/jun":(192,9,206), "08/jun":(246,11,262), "15/jun":(275,8,285), "22/jun":(251,14,266)},
    "Post Venta Seller Dev":                     {"04/mai":(215,18,249), "11/mai":(194,24,235), "18/mai":(181,19,210), "25/mai":(204,12,236), "01/jun":(181,18,218), "08/jun":(173,17,213), "15/jun":(196,16,227), "22/jun":(180,15,217)},
    "Publicaciones Mature":                      {"04/mai":(22,4,30), "11/mai":(27,5,32), "18/mai":(21,3,29), "25/mai":(19,5,24), "01/jun":(27,4,32), "08/jun":(25,3,31), "15/jun":(19,3,25), "22/jun":(27,4,38)},
    "Publicaciones Meli Pro":                    {"04/mai":(96,5,104), "11/mai":(89,3,92), "18/mai":(88,1,90), "25/mai":(87,4,95), "01/jun":(68,3,80), "08/jun":(50,1,51), "15/jun":(42,4,51), "22/jun":(65,1,67)},
    "Publicaciones Seller Dev":                  {"04/mai":(370,100,520), "11/mai":(371,81,493), "18/mai":(378,96,510), "25/mai":(476,104,649), "01/jun":(416,78,554), "08/jun":(448,96,589), "15/jun":(416,66,526), "22/jun":(402,63,519)},
}
